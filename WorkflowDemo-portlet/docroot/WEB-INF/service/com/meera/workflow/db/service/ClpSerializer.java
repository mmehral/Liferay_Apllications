...
import com.meera.workflow.db.model.FeedbackClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"WorkflowDemo-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "WorkflowDemo-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.meera.workflow.db.model.impl.FeedbackImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.meera.workflow.db.exception.NoSuchFeedbackException")) {
			return new com.meera.workflow.db.exception.NoSuchFeedbackException(throwable.getMessage(),
				throwable.getCause());
		}
