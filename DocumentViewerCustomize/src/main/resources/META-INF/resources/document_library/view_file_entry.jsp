...
<div class="closed container-fluid-1280 sidenav-container sidenav-right" id="<portlet:namespace />infoPanelId">
 ...
 <%     Layout layout1= themeDisplay.getLayout();
        ...
        String myValue = httpOrigReq.getParameter("name");
        
        String infoDownloadOption=httpOrigReq.getParameter("info");
        String showComment=httpOrigReq.getParameter("showcomment");
      
        if(showComment==null){
        	showComment="true";
        }
        
        if(infoDownloadOption==null){
        	infoDownloadOption="true";
        }
        System.out.println("Info download parameter : "+infoDownloadOption);
        //String articleId = req.getParameter("articleId");
      
  	 %>
  	 
  	 <%
  	 if(layout1.getName(locale).equalsIgnoreCase("document")){
  		 %>
	...
	<!--Code By Mohit Start : Info Button hide  -->
	
	<%
 	 if(!infoDownloadOption.equalsIgnoreCase("false")){
 		%>
...
<%--  	<div class="btn-group">
	...
	%>
		...
		<!--Code By Mohit End : Info Button hide  -->
	</c:if>
	...
	<div class="sidenav-content">
		...
		<div class="body-row">
		<!-- Code by Mohit Start : Hiding document title, thumbnail and extra space  -->
		<%
		 if((!infoDownloadOption.equalsIgnoreCase("false"))&&(!layout1.getName(locale).equalsIgnoreCase("document"))){
 		 %>
 		...
 		%>
		<!--Code by Mohit End : Hiding document title, thumbnail and extra space  -->
...
<!-- Code by Mohit Start : Showing asset Ratings Above Comment Section -->
			<%
			 if((infoDownloadOption.equalsIgnoreCase("false"))&&(layout1.getName(locale).equalsIgnoreCase("document"))){
 		 %>
...
<%} %>
<!-- Code by Mohit End : Showing asset Ratings Above Comment Section -->


<!-- Hiding Comment for document layout -->
<%


if(!(showComment.equalsIgnoreCase("false"))){ 
