...
/**
 * Provides the local service interface for contentuniqueinformation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author cloverliferay01
 * @see contentuniqueinformationLocalServiceUtil
...
public interface contentuniqueinformationLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link contentuniqueinformationLocalServiceUtil} to access the contentuniqueinformation local service. Add custom service methods to {@link com.chola.ppcontent.service.impl.contentuniqueinformationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
