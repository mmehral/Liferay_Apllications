...
/**
 * Provides the local service interface for LiveFeed. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author adms.java1
 * @see LiveFeedLocalServiceUtil
...
public interface LiveFeedLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LiveFeedLocalServiceUtil} to access the live feed local service. Add custom service methods to {@link com.chola.livefeed.service.impl.LiveFeedLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public LiveFeed addLiveFeed(LiveFeed liveFeed);
	...
	*/
	public LiveFeed createLiveFeed(long id);
	...
	*/
	...
	public LiveFeed deleteLiveFeed(LiveFeed liveFeed);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public LiveFeed deleteLiveFeed(long id) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LiveFeed fetchLiveFeed(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LiveFeed getLiveFeed(long id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public LiveFeed updateLiveFeed(LiveFeed liveFeed);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<java.lang.String> getContentLiveNews();

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<java.lang.String> getLiveContent(java.lang.String createdate);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LiveFeed> getLiveFeeds(int start, int end);
