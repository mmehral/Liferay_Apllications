...
LiveFeed  ref=(LiveFeed)row.getObject();
%>
<%
 PortletURL editURL=renderResponse.createRenderURL();
editURL.setParameter("id", Long.toString(ref.getId()));
editURL.setParameter("jspPage", "/html/updatelivefeed.jsp"); 

PortletURL deleteURL=renderResponse.createActionURL();
deleteURL.setParameter("id", Long.toString(ref.getId()));
deleteURL.setParameter(actionRequest.ACTION_NAME, "deletelivefeed");
%>
...
<liferay-ui:icon-delete url="<%=deleteURL.toString()%>" image="delete"
		message="Delete Live Feed"></liferay-ui:icon-delete>
</liferay-ui:icon-menu>
