...
public class corporatepersonalisedparameterscontentstoreClp
	...
	public void setId(long id) {
		...
		if (_corporatepersonalisedparameterscontentstoreRemoteModel != null) {
			try {
				Class<?> clazz = _corporatepersonalisedparameterscontentstoreRemoteModel.getClass();

				Method method = clazz.getMethod("setId", long.class);

				method.invoke(_corporatepersonalisedparameterscontentstoreRemoteModel,
					id);
			}
			catch (Exception e) {
	...
	public BaseModel<?> getcorporatepersonalisedparameterscontentstoreRemoteModel() {
		return _corporatepersonalisedparameterscontentstoreRemoteModel;
	}

	public void setcorporatepersonalisedparameterscontentstoreRemoteModel(
		BaseModel<?> corporatepersonalisedparameterscontentstoreRemoteModel) {
		_corporatepersonalisedparameterscontentstoreRemoteModel = corporatepersonalisedparameterscontentstoreRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _corporatepersonalisedparameterscontentstoreRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_corporatepersonalisedparameterscontentstoreRemoteModel,
	...
	public void persist() {
		if (this.isNew()) {
			corporatepersonalisedparameterscontentstoreLocalServiceUtil.addcorporatepersonalisedparameterscontentstore(this);
		}
		else {
			corporatepersonalisedparameterscontentstoreLocalServiceUtil.updatecorporatepersonalisedparameterscontentstore(this);
		}
	}

	@Override
	public corporatepersonalisedparameterscontentstore toEscapedModel() {
		return (corporatepersonalisedparameterscontentstore)ProxyUtil.newProxyInstance(corporatepersonalisedparameterscontentstore.class.getClassLoader(),
			new Class[] { corporatepersonalisedparameterscontentstore.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		corporatepersonalisedparameterscontentstoreClp clone = new corporatepersonalisedparameterscontentstoreClp();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof corporatepersonalisedparameterscontentstoreClp)) {
			return false;
		}

		corporatepersonalisedparameterscontentstoreClp corporatepersonalisedparameterscontentstore =
			(corporatepersonalisedparameterscontentstoreClp)obj;
	...
	private BaseModel<?> _corporatepersonalisedparameterscontentstoreRemoteModel;
