...
/**
 * Provides the local service interface for corporatecontentuniqueinformation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author adms.java1
 * @see corporatecontentuniqueinformationLocalServiceUtil
...
public interface corporatecontentuniqueinformationLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link corporatecontentuniqueinformationLocalServiceUtil} to access the corporatecontentuniqueinformation local service. Add custom service methods to {@link com.chola.calendar.service.impl.corporatecontentuniqueinformationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public corporatecontentuniqueinformation addcorporatecontentuniqueinformation(
	...
	*/
	public corporatecontentuniqueinformation createcorporatecontentuniqueinformation(
		long id);
	...
	*/
	...
	public corporatecontentuniqueinformation deletecorporatecontentuniqueinformation(
		corporatecontentuniqueinformation corporatecontentuniqueinformation);
	...
	*/
	...
	public corporatecontentuniqueinformation fetchcorporatecontentuniqueinformation(
		long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public corporatecontentuniqueinformation getcorporatecontentuniqueinformation(
		long id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public corporatecontentuniqueinformation updatecorporatecontentuniqueinformation(
		corporatecontentuniqueinformation corporatecontentuniqueinformation);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<corporatecontentuniqueinformation> getCorporateEventId(
		long contentId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<corporatecontentuniqueinformation> getcorporatecontentuniqueinformations(
		int start, int end);
