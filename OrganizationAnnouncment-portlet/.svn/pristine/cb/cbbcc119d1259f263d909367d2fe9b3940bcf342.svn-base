...
public class organizationLocalServiceClp implements organizationLocalService {
	public organizationLocalServiceClp(
		...
		_methodName5 = "addorganization";

		_methodParameterTypes5 = new String[] {
				"com.organizationAnnouncement.model.organization"
			};

		_methodName6 = "createorganization";

		_methodParameterTypes6 = new String[] { "long" };

		_methodName7 = "deleteorganization";

		_methodParameterTypes7 = new String[] {
				"com.organizationAnnouncement.model.organization"
			};

		_methodName8 = "deleteorganization";

		_methodParameterTypes8 = new String[] { "long" };

		_methodName9 = "fetchorganization";

		_methodParameterTypes9 = new String[] { "long" };

		_methodName10 = "getorganization";

		_methodParameterTypes10 = new String[] { "long" };

		_methodName11 = "updateorganization";

		_methodParameterTypes11 = new String[] {
				"com.organizationAnnouncement.model.organization"
			};

		_methodName12 = "getorganizationsCount";
		...
		_methodName18 = "getorganizations";
	...
	public com.organizationAnnouncement.model.organization addorganization(
		...
		return (com.organizationAnnouncement.model.organization)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.organizationAnnouncement.model.organization createorganization(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName6,
					_methodParameterTypes6, new Object[] { organization_id });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.organizationAnnouncement.model.organization deleteorganization(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName8,
					_methodParameterTypes8, new Object[] { organization_id });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.organizationAnnouncement.model.organization fetchorganization(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { organization_id });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.organizationAnnouncement.model.organization getorganization(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { organization_id });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.organizationAnnouncement.model.organization> getorganizations(
		...
		return (java.util.List<com.organizationAnnouncement.model.organization>)ClpSerializer.translateOutput(returnObj);
	}
