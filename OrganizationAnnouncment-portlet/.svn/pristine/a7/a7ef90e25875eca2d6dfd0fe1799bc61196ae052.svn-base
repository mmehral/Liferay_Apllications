...
/**
 * The extended model interface for the organization service. Represents a row in the &quot;organizationAnnouncement_organization&quot; database table, with each column mapped to a property of this class.
 *
 * @author adms.java1
 ...
 * @generated
 */
@ImplementationClassName("com.organizationAnnouncement.model.impl.organizationImpl")
@ProviderType
public interface organization extends organizationModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link com.organizationAnnouncement.model.impl.organizationImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
