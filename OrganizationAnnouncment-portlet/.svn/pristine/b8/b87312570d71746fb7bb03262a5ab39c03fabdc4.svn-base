...
import com.organizationAnnouncement.model.organizationClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"OrganizationAnnouncment-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "OrganizationAnnouncment-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.organizationAnnouncement.model.impl.organizationImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.organizationAnnouncement.exception.NoSuchorganizationException")) {
			return new com.organizationAnnouncement.exception.NoSuchorganizationException(throwable.getMessage(),
				throwable.getCause());
		}
