...
public class contentupdateWrapper implements contentupdate,
	...
	@Override
	public com.content.model.contentupdate toEscapedModel() {
		return new contentupdateWrapper(_contentupdate.toEscapedModel());
	}

	@Override
	public com.content.model.contentupdate toUnescapedModel() {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<com.content.model.contentupdate> toCacheModel() {
		return _contentupdate.toCacheModel();
	}

	@Override
	public int compareTo(com.content.model.contentupdate contentupdate) {
