...
package com.content.service.persistence;
...
/**
 * The persistence interface for the contentupdate service.
 *
 * <p>
 ...
 * @see com.content.service.persistence.impl.contentupdatePersistenceImpl
 * @see contentupdateUtil
 * @generated
 */
@ProviderType
public interface contentupdatePersistence extends BasePersistence<contentupdate> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link contentupdateUtil} to access the contentupdate persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<contentupdate> contentupdates);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, contentupdate> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<contentupdate> findAll();
	...
	*/
	public java.util.List<contentupdate> findAll(int start, int end);
	...
	*/
	public java.util.List<contentupdate> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<contentupdate> orderByComparator);
