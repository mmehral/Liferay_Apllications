...
import com.pratice.model.empClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"Pratice03-07-2017-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "Pratice03-07-2017-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("com.pratice.model.impl.empImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.pratice.exception.NoSuchempException")) {
			return new com.pratice.exception.NoSuchempException(throwable.getMessage(),
				throwable.getCause());
		}
