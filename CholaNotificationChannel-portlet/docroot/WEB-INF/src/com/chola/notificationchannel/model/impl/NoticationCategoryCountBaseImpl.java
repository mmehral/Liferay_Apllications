...
/**
 * The extended model base implementation for the NoticationCategoryCount service. Represents a row in the &quot;channel_NoticationCategoryCount&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This class exists only as a container for the default extended model level methods generated by ServiceBuilder. Helper methods and all application logic should be put in {@link NoticationCategoryCountImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class NoticationCategoryCountBaseImpl
	extends NoticationCategoryCountModelImpl implements NoticationCategoryCount {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
