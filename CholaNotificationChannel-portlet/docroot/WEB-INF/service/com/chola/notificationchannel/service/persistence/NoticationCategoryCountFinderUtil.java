...
public class NoticationCategoryCountFinderUtil {
	...
	public static java.util.List<java.lang.Object[]> getActiveEmployeeInfoFromTable(
		...
		return getFinder().getActiveEmployeeInfoFromTable(empId);
	}

	public static java.util.List<java.lang.Object[]> getPeoplePowerNotificationDetails(
		java.lang.String empId) {
		return getFinder().getPeoplePowerNotificationDetails(empId);
	}

	public static java.util.List<java.lang.Object[]> getQtracNotificationDetails(
		java.lang.String empId) {
		return getFinder().getQtracNotificationDetails(empId);
	}

	public static NoticationCategoryCountFinder getFinder() {
		if (_finder == null) {
			_finder = (NoticationCategoryCountFinder)PortletBeanLocatorUtil.locate(com.chola.notificationchannel.service.ClpSerializer.getServletContextName(),
