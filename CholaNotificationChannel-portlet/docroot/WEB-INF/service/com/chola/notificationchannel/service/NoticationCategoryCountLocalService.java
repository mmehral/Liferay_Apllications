...
public interface NoticationCategoryCountLocalService extends BaseLocalService,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<java.lang.Object[]> getActiveEmployeeInfoFromTable(
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<java.lang.Object[]> getPeoplePowerNotificationDetails(
		java.lang.String empId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<java.lang.Object[]> getQtracNotificationDetails(
		java.lang.String empId);
