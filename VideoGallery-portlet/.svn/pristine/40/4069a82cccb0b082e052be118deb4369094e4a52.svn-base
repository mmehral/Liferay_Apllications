...
/**
 * Provides the local service interface for videogallerypath. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author CloverLiferay02
 * @see videogallerypathLocalServiceUtil
...
public interface videogallerypathLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link videogallerypathLocalServiceUtil} to access the videogallerypath local service. Add custom service methods to {@link com.chola.videogallery.service.impl.videogallerypathLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<videogallerypath> getAlbumDetails(java.lang.String albumId);
