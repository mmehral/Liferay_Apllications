 ...
 * {@link com.chola.videogallery.service.impl.videogalleryLocalServiceImpl} and is the
 ...
 * @see com.chola.videogallery.service.base.videogalleryLocalServiceBaseImpl
...
public class videogalleryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.chola.videogallery.service.impl.videogalleryLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.chola.videogallery.model.videogallery addvideogallery(
	...
	*/
	public static com.chola.videogallery.model.videogallery createvideogallery(
		long id) {
		return getService().createvideogallery(id);
	}
	...
	*/
	public static com.chola.videogallery.model.videogallery deletevideogallery(
		com.chola.videogallery.model.videogallery videogallery) {
	...
	*/
	public static com.chola.videogallery.model.videogallery deletevideogallery(
		...
		return getService().deletevideogallery(id);
	}

	public static com.chola.videogallery.model.videogallery fetchvideogallery(
		long id) {
		return getService().fetchvideogallery(id);
	}
	...
	* @throws PortalException if a videogallery with the primary key could not be found
	*/
	public static com.chola.videogallery.model.videogallery getvideogallery(
		long id) throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getvideogallery(id);
	}
	...
	*/
	public static com.chola.videogallery.model.videogallery updatevideogallery(
		com.chola.videogallery.model.videogallery videogallery) {
	...
	*/
	public static java.util.List<com.chola.videogallery.model.videogallery> getvideogalleries(
		int start, int end) {
	...
	*/
	...
	public static videogalleryLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					videogalleryLocalService.class.getName());

			if (invokableLocalService instanceof videogalleryLocalService) {
				_service = (videogalleryLocalService)invokableLocalService;
			}
			else {
				_service = new videogalleryLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(videogalleryLocalServiceUtil.class,
				"_service");
		}
	...
	private static videogalleryLocalService _service;
}