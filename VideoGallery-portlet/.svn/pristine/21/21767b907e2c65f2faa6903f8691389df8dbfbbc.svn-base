 ...
 */
@ProviderType
public class videogalleryLocalServiceClp implements videogalleryLocalService {
	public videogalleryLocalServiceClp(
		...
		_methodName4 = "fetchvideogallery";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "getvideogallery";

		_methodParameterTypes5 = new String[] { "long" };

		_methodName6 = "updatevideogallery";
		...
		_methodName12 = "getvideogalleriesCount";
		...
		_methodName18 = "getvideogalleries";
	...
	public com.chola.videogallery.model.videogallery addvideogallery(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(videogallery) });
		}
		catch (Throwable t) {
		...
		return (com.chola.videogallery.model.videogallery)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.chola.videogallery.model.videogallery> getvideogalleries(
		...
		return (java.util.List<com.chola.videogallery.model.videogallery>)ClpSerializer.translateOutput(returnObj);
	}
