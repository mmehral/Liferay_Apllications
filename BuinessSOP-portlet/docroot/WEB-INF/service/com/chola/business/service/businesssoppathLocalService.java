...
/**
 * Provides the local service interface for businesssoppath. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author adms.java1
 * @see businesssoppathLocalServiceUtil
...
public interface businesssoppathLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link businesssoppathLocalServiceUtil} to access the businesssoppath local service. Add custom service methods to {@link com.chola.business.service.impl.businesssoppathLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
