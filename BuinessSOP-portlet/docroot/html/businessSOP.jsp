...
<script type="text/javascript">
	$(document).ready(function() {
		...
		document.getElementById("<portlet:namespace/>myBtn").disabled = true;
...
Business SOP : <input type="checkbox" id="checkboxSOPshowhide" name="checkboxSOPshowhide" checked/> 

		<div id="sopdiv">
				<input type="hidden" id="productlist"
			name="<portlet:namespace/>contestlist" value="0">
			<aui:input type="text" name="buinesstitle" id="buinesstitle" label="Buisness Title">
				<aui:validator name="required"></aui:validator>
				 <aui:validator name="max">500</aui:validator>
			</aui:input>

			<aui:input type="text" name="buinessDesc" id="buinessDesc"
...
<script>
		function getvalidation() {
			...
			var check=document.getElementById('checkboxSOPshowhide').checked;
