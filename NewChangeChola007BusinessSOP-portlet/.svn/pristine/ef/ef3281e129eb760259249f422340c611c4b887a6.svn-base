 ...
 * @see com.chola.personalisedparameters.service.persistence.impl.bsoppathPersistenceImpl
 * @generated
 */
@ProviderType
public class bsoppathUtil {
	...
	*/
	public static bsoppath findBySOP_ID_First(long bdetails_id,
		OrderByComparator<bsoppath> orderByComparator)
		throws com.chola.personalisedparameters.exception.NoSuchbsoppathException {
		return getPersistence()
	...
	* @return the matching bsoppaths
	*/
	public static List<bsoppath> findByBCONTENT_ID(long bdetailscontent_id) {
		return getPersistence().findByBCONTENT_ID(bdetailscontent_id);
	}
	...
	*/
	public static List<bsoppath> findByBCONTENT_ID(long bdetailscontent_id,
		int start, int end) {
		return getPersistence().findByBCONTENT_ID(bdetailscontent_id, start, end);
	}
	...
	*/
	public static List<bsoppath> findByBCONTENT_ID(long bdetailscontent_id,
		...
		return getPersistence()
				   .findByBCONTENT_ID(bdetailscontent_id, start, end,
			orderByComparator);
	}
	...
	* @throws NoSuchbsoppathException if a matching bsoppath could not be found
	*/
	public static bsoppath findByBCONTENT_ID_First(long bdetailscontent_id,
		OrderByComparator<bsoppath> orderByComparator)
		throws com.chola.personalisedparameters.exception.NoSuchbsoppathException {
		return getPersistence()
				   .findByBCONTENT_ID_First(bdetailscontent_id,
			orderByComparator);
	}
	...
	* @return the first matching bsoppath, or <code>null</code> if a matching bsoppath could not be found
	*/
	public static bsoppath fetchByBCONTENT_ID_First(long bdetailscontent_id,
		OrderByComparator<bsoppath> orderByComparator) {
		return getPersistence()
				   .fetchByBCONTENT_ID_First(bdetailscontent_id,
			orderByComparator);
	}
	...
	* @throws NoSuchbsoppathException if a matching bsoppath could not be found
	*/
	public static bsoppath findByBCONTENT_ID_Last(long bdetailscontent_id,
		OrderByComparator<bsoppath> orderByComparator)
		throws com.chola.personalisedparameters.exception.NoSuchbsoppathException {
		return getPersistence()
				   .findByBCONTENT_ID_Last(bdetailscontent_id, orderByComparator);
	}
	...
	* @return the last matching bsoppath, or <code>null</code> if a matching bsoppath could not be found
	*/
	public static bsoppath fetchByBCONTENT_ID_Last(long bdetailscontent_id,
		OrderByComparator<bsoppath> orderByComparator) {
		return getPersistence()
				   .fetchByBCONTENT_ID_Last(bdetailscontent_id,
			orderByComparator);
	}
	...
	* @throws NoSuchbsoppathException if a bsoppath with the primary key could not be found
	*/
	public static bsoppath[] findByBCONTENT_ID_PrevAndNext(long id,
		long bdetailscontent_id, OrderByComparator<bsoppath> orderByComparator)
		throws com.chola.personalisedparameters.exception.NoSuchbsoppathException {
		return getPersistence()
				   .findByBCONTENT_ID_PrevAndNext(id, bdetailscontent_id,
			orderByComparator);
	}
	...
	* @param bdetailscontent_id the bdetailscontent_id
	*/
	public static void removeByBCONTENT_ID(long bdetailscontent_id) {
		getPersistence().removeByBCONTENT_ID(bdetailscontent_id);
	}
	...
	* @return the number of matching bsoppaths
	*/
	public static int countByBCONTENT_ID(long bdetailscontent_id) {
		return getPersistence().countByBCONTENT_ID(bdetailscontent_id);
	}
	...
	*/
	...
	public static bsoppathPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (bsoppathPersistence)PortletBeanLocatorUtil.locate(com.chola.personalisedparameters.service.ClpSerializer.getServletContextName(),
