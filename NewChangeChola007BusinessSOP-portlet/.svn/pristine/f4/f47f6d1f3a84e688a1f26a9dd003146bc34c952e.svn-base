 ...
 * @generated
 */
@ImplementationClassName("com.chola.personalisedparameters.model.impl.bsoppathImpl")
@ProviderType
public interface bsoppath extends bsoppathModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link com.chola.personalisedparameters.model.impl.bsoppathImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
