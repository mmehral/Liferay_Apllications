...
/**
 * Provides the local service interface for bsoppath. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author cloverliferay01
 * @see bsoppathLocalServiceUtil
...
public interface bsoppathLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link bsoppathLocalServiceUtil} to access the bsoppath local service. Add custom service methods to {@link com.chola.personalisedparameters.service.impl.bsoppathLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<bsoppath> getSOPdocuments(long sopId);
