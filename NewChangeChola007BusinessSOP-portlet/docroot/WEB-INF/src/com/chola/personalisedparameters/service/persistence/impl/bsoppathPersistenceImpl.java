...
import com.chola.personalisedparameters.exception.NoSuchbsoppathException;
import com.chola.personalisedparameters.model.bsoppath;
import com.chola.personalisedparameters.model.impl.bsoppathImpl;
import com.chola.personalisedparameters.model.impl.bsoppathModelImpl;
 ...
 * @see com.chola.personalisedparameters.service.persistence.bsoppathUtil
 * @generated
 */
@ProviderType
public class bsoppathPersistenceImpl extends BasePersistenceImpl<bsoppath>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_BCONTENT_ID =
		new FinderPath(bsoppathModelImpl.ENTITY_CACHE_ENABLED,
			bsoppathModelImpl.FINDER_CACHE_ENABLED, bsoppathImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByBCONTENT_ID",
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_BCONTENT_ID =
		new FinderPath(bsoppathModelImpl.ENTITY_CACHE_ENABLED,
			bsoppathModelImpl.FINDER_CACHE_ENABLED, bsoppathImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByBCONTENT_ID",
			new String[] { Long.class.getName() },
			bsoppathModelImpl.BDETAILSCONTENT_ID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_BCONTENT_ID = new FinderPath(bsoppathModelImpl.ENTITY_CACHE_ENABLED,
			bsoppathModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByBCONTENT_ID",
			new String[] { Long.class.getName() });
	 ...
	 */
	@Override
	public List<bsoppath> findByBCONTENT_ID(long bdetailscontent_id) {
		return findByBCONTENT_ID(bdetailscontent_id, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<bsoppath> findByBCONTENT_ID(long bdetailscontent_id, int start,
		int end) {
		return findByBCONTENT_ID(bdetailscontent_id, start, end, null);
	}
	...
	public List<bsoppath> findByBCONTENT_ID(long bdetailscontent_id, int start,
		...
		return findByBCONTENT_ID(bdetailscontent_id, start, end,
			orderByComparator, true);
	}
	...
	public List<bsoppath> findByBCONTENT_ID(long bdetailscontent_id, int start,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_BCONTENT_ID;
			finderArgs = new Object[] { bdetailscontent_id };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_BCONTENT_ID;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_BCONTENT_ID_BDETAILSCONTENT_ID_2);
	 ...
	 */
	@Override
	public bsoppath findByBCONTENT_ID_First(long bdetailscontent_id,
		OrderByComparator<bsoppath> orderByComparator)
		throws NoSuchbsoppathException {
		bsoppath bsoppath = fetchByBCONTENT_ID_First(bdetailscontent_id,
				orderByComparator);
	 ...
	 */
	@Override
	public bsoppath fetchByBCONTENT_ID_First(long bdetailscontent_id,
		OrderByComparator<bsoppath> orderByComparator) {
		List<bsoppath> list = findByBCONTENT_ID(bdetailscontent_id, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public bsoppath findByBCONTENT_ID_Last(long bdetailscontent_id,
		OrderByComparator<bsoppath> orderByComparator)
		throws NoSuchbsoppathException {
		bsoppath bsoppath = fetchByBCONTENT_ID_Last(bdetailscontent_id,
				orderByComparator);
	 ...
	 */
	@Override
	public bsoppath fetchByBCONTENT_ID_Last(long bdetailscontent_id,
		OrderByComparator<bsoppath> orderByComparator) {
		int count = countByBCONTENT_ID(bdetailscontent_id);

		if (count == 0) {
			return null;
		}

		List<bsoppath> list = findByBCONTENT_ID(bdetailscontent_id, count - 1,
	 ...
	 */
	@Override
	public bsoppath[] findByBCONTENT_ID_PrevAndNext(long id,
		...
		try {
			...
			array[0] = getByBCONTENT_ID_PrevAndNext(session, bsoppath,
					bdetailscontent_id, orderByComparator, true);

			array[1] = bsoppath;

			array[2] = getByBCONTENT_ID_PrevAndNext(session, bsoppath,
	...
	protected bsoppath getByBCONTENT_ID_PrevAndNext(Session session,
	 ...
	 */
	@Override
	public void removeByBCONTENT_ID(long bdetailscontent_id) {
		for (bsoppath bsoppath : findByBCONTENT_ID(bdetailscontent_id,
	 ...
	 */
	@Override
	public int countByBCONTENT_ID(long bdetailscontent_id) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_BCONTENT_ID;
	...
	private static final String _FINDER_COLUMN_BCONTENT_ID_BDETAILSCONTENT_ID_2 = "bsoppath.bdetailscontent_id = ?";
	...
	public bsoppath updateImpl(bsoppath bsoppath) {
		...
		if (isNew || !bsoppathModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((bsoppathModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_BCONTENT_ID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						bsoppathModelImpl.getOriginalBdetailscontent_id()
					};

				finderCache.removeResult(FINDER_PATH_COUNT_BY_BCONTENT_ID, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_BCONTENT_ID,
					args);
