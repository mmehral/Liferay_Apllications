...
import com.chola.trainingcalendar.service.trainingcalendarLocalService;
...
/**
 * Provides the base implementation for the trainingcalendar local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.chola.trainingcalendar.service.impl.trainingcalendarLocalServiceImpl}.
 * </p>
 *
 * @author CloverLiferay01
 * @see com.chola.trainingcalendar.service.impl.trainingcalendarLocalServiceImpl
 * @see com.chola.trainingcalendar.service.trainingcalendarLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class trainingcalendarLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements trainingcalendarLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.chola.trainingcalendar.service.trainingcalendarLocalServiceUtil} to access the trainingcalendar local service.
	 */
	...
	public trainingcalendar addtrainingcalendar(
		...
		return trainingcalendarPersistence.update(trainingcalendar);
	}
	...
	public trainingcalendar createtrainingcalendar(long trainingid) {
		return trainingcalendarPersistence.create(trainingid);
	}
	...
	public trainingcalendar deletetrainingcalendar(long trainingid)
		...
		return trainingcalendarPersistence.remove(trainingid);
	}
	...
	public trainingcalendar deletetrainingcalendar(
		trainingcalendar trainingcalendar) {
		return trainingcalendarPersistence.remove(trainingcalendar);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(trainingcalendar.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return trainingcalendarPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return trainingcalendarPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public trainingcalendar fetchtrainingcalendar(long trainingid) {
		return trainingcalendarPersistence.fetchByPrimaryKey(trainingid);
	}
	...
	public trainingcalendar gettrainingcalendar(long trainingid)
		throws PortalException {
		return trainingcalendarPersistence.findByPrimaryKey(trainingid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(trainingcalendarLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(trainingcalendar.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(trainingcalendarLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(trainingcalendar.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return trainingcalendarLocalService.deletetrainingcalendar((trainingcalendar)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return trainingcalendarPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<trainingcalendar> gettrainingcalendars(int start, int end) {
		return trainingcalendarPersistence.findAll(start, end);
	}
	...
	public int gettrainingcalendarsCount() {
		return trainingcalendarPersistence.countAll();
	}
	 ...
	 */
	public trainingcalendarLocalService gettrainingcalendarLocalService() {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.chola.trainingcalendar.model.trainingcalendar",
			trainingcalendarLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return trainingcalendarLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = trainingcalendarPersistence.getDataSource();
	...
	@BeanReference(type = trainingcalendarLocalService.class)
	protected trainingcalendarLocalService trainingcalendarLocalService;
	...
	private trainingcalendarLocalServiceClpInvoker _clpInvoker = new trainingcalendarLocalServiceClpInvoker();
}