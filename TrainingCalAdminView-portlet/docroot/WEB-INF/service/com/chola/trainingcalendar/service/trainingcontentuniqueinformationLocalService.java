...
/**
 * Provides the local service interface for trainingcontentuniqueinformation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author CloverLiferay01
 * @see trainingcontentuniqueinformationLocalServiceUtil
...
public interface trainingcontentuniqueinformationLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link trainingcontentuniqueinformationLocalServiceUtil} to access the trainingcontentuniqueinformation local service. Add custom service methods to {@link com.chola.trainingcalendar.service.impl.trainingcontentuniqueinformationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public trainingcontentuniqueinformation addtrainingcontentuniqueinformation(
	...
	*/
	public trainingcontentuniqueinformation createtrainingcontentuniqueinformation(
		long id);
	...
	*/
	...
	public trainingcontentuniqueinformation deletetrainingcontentuniqueinformation(
		trainingcontentuniqueinformation trainingcontentuniqueinformation);
	...
	*/
	...
	public trainingcontentuniqueinformation fetchtrainingcontentuniqueinformation(
		long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public trainingcontentuniqueinformation gettrainingcontentuniqueinformation(
		long id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public trainingcontentuniqueinformation updatetrainingcontentuniqueinformation(
		trainingcontentuniqueinformation trainingcontentuniqueinformation);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<trainingcontentuniqueinformation> gettrainingcontentuniqueinformations(
		int start, int end);
