...
/**
 * Provides the local service interface for trainingintendedtable. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author CloverLiferay01
 * @see trainingintendedtableLocalServiceUtil
...
public interface trainingintendedtableLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link trainingintendedtableLocalServiceUtil} to access the trainingintendedtable local service. Add custom service methods to {@link com.chola.trainingcalendar.service.impl.trainingintendedtableLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
