...
/**
 * Provides the local service interface for trainingcalendar. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author CloverLiferay01
 * @see trainingcalendarLocalServiceUtil
...
public interface trainingcalendarLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link trainingcalendarLocalServiceUtil} to access the trainingcalendar local service. Add custom service methods to {@link com.chola.trainingcalendar.service.impl.trainingcalendarLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public trainingcalendar addtrainingcalendar(
	...
	*/
	public trainingcalendar createtrainingcalendar(long trainingid);
	...
	*/
	...
	public trainingcalendar deletetrainingcalendar(
		trainingcalendar trainingcalendar);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public trainingcalendar deletetrainingcalendar(long trainingid)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public trainingcalendar fetchtrainingcalendar(long trainingid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public trainingcalendar gettrainingcalendar(long trainingid)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public trainingcalendar updatetrainingcalendar(
		trainingcalendar trainingcalendar);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<java.lang.Object[]> getIntendedUserList(
		java.lang.String location, java.lang.String companyname);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<java.lang.Object[]> getIntendedUserTrainingList(
		java.lang.String screenName);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<java.lang.Object[]> getTrainingList();

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<java.lang.Object[]> getUsersData();
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<trainingcalendar> gettrainingcalendars(int start, int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<java.lang.Object[]> gettrainingresponses();
