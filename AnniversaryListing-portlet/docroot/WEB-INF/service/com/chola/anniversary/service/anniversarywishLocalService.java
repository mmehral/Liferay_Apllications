...
/**
 * Provides the local service interface for anniversarywish. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author CloverLiferay02
 * @see anniversarywishLocalServiceUtil
...
public interface anniversarywishLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link anniversarywishLocalServiceUtil} to access the anniversarywish local service. Add custom service methods to {@link com.chola.anniversary.service.impl.anniversarywishLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
