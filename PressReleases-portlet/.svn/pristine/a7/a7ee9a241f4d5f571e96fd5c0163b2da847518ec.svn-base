...
/**
 * The persistence utility for the pressrelease service. This utility wraps {@link com.chola.pressrelease.service.persistence.impl.pressreleasePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class pressreleaseUtil {
	...
	*/
	public static pressrelease remove(long id)
		throws com.chola.pressrelease.exception.NoSuchpressreleaseException {
	...
	*/
	...
	public static pressreleasePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (pressreleasePersistence)PortletBeanLocatorUtil.locate(com.chola.pressrelease.service.ClpSerializer.getServletContextName(),
