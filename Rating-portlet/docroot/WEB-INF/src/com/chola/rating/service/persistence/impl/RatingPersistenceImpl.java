...
package com.chola.rating.service.persistence.impl;

import aQute.bnd.annotation.ProviderType;

import com.chola.rating.exception.NoSuchRatingException;
import com.chola.rating.model.Rating;
import com.chola.rating.model.impl.RatingImpl;
import com.chola.rating.model.impl.RatingModelImpl;
 ...
 * @see com.chola.rating.service.persistence.RatingUtil
 * @generated
 */
@ProviderType
public class RatingPersistenceImpl extends BasePersistenceImpl<Rating>
	...
	protected Rating toUnwrappedModel(Rating rating) {
		...
		ratingImpl.setContent(rating.getContent());
	...
	public Rating fetchByPrimaryKey(Serializable primaryKey) {
		Rating rating = (Rating)entityCache.getResult(RatingModelImpl.ENTITY_CACHE_ENABLED,
	...
	private static final Rating _nullRating = new RatingImpl() {
			@Override
			public Object clone() {
				return this;
			}
	...
	private static final CacheModel<Rating> _nullRatingCacheModel = new CacheModel<Rating>() {
			@Override
