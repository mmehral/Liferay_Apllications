...
import com.chola.rating.model.RatingClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"Rating-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "Rating-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("com.chola.rating.model.impl.RatingImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.chola.rating.exception.NoSuchRatingException")) {
			return new com.chola.rating.exception.NoSuchRatingException(throwable.getMessage(),
				throwable.getCause());
		}
