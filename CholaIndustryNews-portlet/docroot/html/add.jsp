...
<liferay-ui:error key="error-key" message="News Already Present for same Date" />
...
<form action="<%=industryURL%>" id="myForm" name="form" onSubmit="return validateform()" method="post">
	...
	Indusrty News Content:<liferay-ui:input-editor name="content" initMethod="initEditor"
