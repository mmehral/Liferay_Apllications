 ...
 * @see com.branchdetails.service.persistence.impl.branchdetailsPersistenceImpl
 * @generated
 */
@ProviderType
public class branchdetailsUtil {
	...
	*/
	public static branchdetails remove(long branch_id)
		throws com.branchdetails.exception.NoSuchdetailsException {
	...
	*/
	...
	public static branchdetailsPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (branchdetailsPersistence)PortletBeanLocatorUtil.locate(com.branchdetails.service.ClpSerializer.getServletContextName(),
