...
import com.branchdetails.model.branchdetailsClp;
import com.branchdetails.model.cityClp;
import com.branchdetails.model.mappingClp;
import com.branchdetails.model.productClp;
import com.branchdetails.model.stateClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"BranchDetails-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "BranchDetails-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.branchdetails.model.impl.branchdetailsImpl")) {
		...
		if (oldModelClassName.equals("com.branchdetails.model.impl.cityImpl")) {
		...
		if (oldModelClassName.equals("com.branchdetails.model.impl.mappingImpl")) {
		...
		if (oldModelClassName.equals("com.branchdetails.model.impl.productImpl")) {
		...
		if (oldModelClassName.equals("com.branchdetails.model.impl.stateImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.branchdetails.exception.NoSuchdetailsException")) {
			return new com.branchdetails.exception.NoSuchdetailsException(throwable.getMessage(),
				throwable.getCause());
		}

		if (className.equals("com.branchdetails.exception.NoSuchcityException")) {
			return new com.branchdetails.exception.NoSuchcityException(throwable.getMessage(),
				throwable.getCause());
		}

		if (className.equals(
					"com.branchdetails.exception.NoSuchmappingException")) {
			return new com.branchdetails.exception.NoSuchmappingException(throwable.getMessage(),
				throwable.getCause());
		}

		if (className.equals(
					"com.branchdetails.exception.NoSuchproductException")) {
			return new com.branchdetails.exception.NoSuchproductException(throwable.getMessage(),
				throwable.getCause());
		}

		if (className.equals("com.branchdetails.exception.NoSuchstateException")) {
			return new com.branchdetails.exception.NoSuchstateException(throwable.getMessage(),
				throwable.getCause());
		}
