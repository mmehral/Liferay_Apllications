...
public class stateWrapper implements state, ModelWrapper<state> {
	...
	@Override
	public com.branchdetails.model.state toEscapedModel() {
		return new stateWrapper(_state.toEscapedModel());
	}

	@Override
	public com.branchdetails.model.state toUnescapedModel() {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<com.branchdetails.model.state> toCacheModel() {
		return _state.toCacheModel();
	}

	@Override
	public int compareTo(com.branchdetails.model.state state) {
