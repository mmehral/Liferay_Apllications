 ...
 * {@link com.branchdetails.service.impl.productLocalServiceImpl} and is the
 ...
 * @see com.branchdetails.service.base.productLocalServiceBaseImpl
 * @see com.branchdetails.service.impl.productLocalServiceImpl
 * @generated
 */
@ProviderType
public class productLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.branchdetails.service.impl.productLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.branchdetails.model.product addproduct(
	...
	*/
	public static com.branchdetails.model.product createproduct(long product_id) {
		return getService().createproduct(product_id);
	}
	...
	*/
	public static com.branchdetails.model.product deleteproduct(
		com.branchdetails.model.product product) {
	...
	*/
	public static com.branchdetails.model.product deleteproduct(long product_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteproduct(product_id);
	}

	public static com.branchdetails.model.product fetchproduct(long product_id) {
		return getService().fetchproduct(product_id);
	}
	...
	* @throws PortalException if a product with the primary key could not be found
	*/
	public static com.branchdetails.model.product getproduct(long product_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getproduct(product_id);
	}
	...
	*/
	public static com.branchdetails.model.product updateproduct(
		com.branchdetails.model.product product) {
	...
	*/
	...
	public static java.util.List<java.lang.String> getBranch(long product_id,
		...
		return getService().getBranch(product_id, state_id, city_id);
	}

	public static java.util.List<java.lang.String> getCity(long product_id,
		long state_id) {
		return getService().getCity(product_id, state_id);
	}
	...
	public static java.util.List<java.lang.String> getState(long product_id) {
		return getService().getState(product_id);
	}
	...
	*/
	public static java.util.List<com.branchdetails.model.product> getproducts(
		int start, int end) {
