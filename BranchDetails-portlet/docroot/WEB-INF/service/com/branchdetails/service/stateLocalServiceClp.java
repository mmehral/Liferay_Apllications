...
public class stateLocalServiceClp implements stateLocalService {
	public stateLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodParameterTypes2 = new String[] { "com.branchdetails.model.state" };
		...
		_methodParameterTypes6 = new String[] { "com.branchdetails.model.state" };
	...
	public com.branchdetails.model.state addstate(
		...
		return (com.branchdetails.model.state)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.branchdetails.model.state> getstates(int start,
		...
		return (java.util.List<com.branchdetails.model.state>)ClpSerializer.translateOutput(returnObj);
	}
