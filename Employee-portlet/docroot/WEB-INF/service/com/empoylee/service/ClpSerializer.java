...
import com.empoylee.model.employeeClp;
...
public class ClpSerializer {
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("com.empoylee.model.impl.employeeImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.empoylee.exception.NoSuchemployeeException")) {
			return new com.empoylee.exception.NoSuchemployeeException(throwable.getMessage(),
				throwable.getCause());
		}
