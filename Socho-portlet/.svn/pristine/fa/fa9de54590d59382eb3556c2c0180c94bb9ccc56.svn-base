 ...
 */
@ProviderType
public class topicsLocalServiceClp implements topicsLocalService {
	public topicsLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodParameterTypes2 = new String[] { "com.chola.socho.model.topics" };

		_methodName3 = "deletetopics";

		_methodParameterTypes3 = new String[] { "long" };

		_methodName4 = "fetchtopics";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "gettopics";

		_methodParameterTypes5 = new String[] { "long" };

		_methodName6 = "updatetopics";

		_methodParameterTypes6 = new String[] { "com.chola.socho.model.topics" };
		...
		_methodName12 = "gettopicsesCount";
	...
	public com.chola.socho.model.topics addtopics(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(topics) });
		}
		catch (Throwable t) {
		...
		return (com.chola.socho.model.topics)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List customFinder(java.lang.String topicId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(topicId) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.chola.socho.model.topics> gettopicses(int start,
		...
		return (java.util.List<com.chola.socho.model.topics>)ClpSerializer.translateOutput(returnObj);
	}
