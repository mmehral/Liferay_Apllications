...
public class topicsModelImpl extends BaseModelImpl<topics>
	...
	public static final String TABLE_SQL_CREATE = "create table socho_topics (id_ LONG not null primary key,topicName VARCHAR(200) null,flag LONG,createdBy LONG,createdOn DATE null,modifiedBy LONG,modifiedOn DATE null)";
