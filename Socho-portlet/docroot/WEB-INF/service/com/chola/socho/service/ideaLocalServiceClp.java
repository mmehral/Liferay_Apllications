 ...
 */
@ProviderType
public class ideaLocalServiceClp implements ideaLocalService {
	public ideaLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodParameterTypes2 = new String[] { "com.chola.socho.model.idea" };

		_methodName3 = "deleteidea";

		_methodParameterTypes3 = new String[] { "long" };

		_methodName4 = "fetchidea";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "getidea";

		_methodParameterTypes5 = new String[] { "long" };

		_methodName6 = "updateidea";

		_methodParameterTypes6 = new String[] { "com.chola.socho.model.idea" };
	...
	public com.chola.socho.model.idea addidea(com.chola.socho.model.idea idea) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(idea) });
		}
		catch (Throwable t) {
		...
		return (com.chola.socho.model.idea)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.chola.socho.model.idea> customFinder(
		...
		return (java.util.List<com.chola.socho.model.idea>)ClpSerializer.translateOutput(returnObj);
	}
