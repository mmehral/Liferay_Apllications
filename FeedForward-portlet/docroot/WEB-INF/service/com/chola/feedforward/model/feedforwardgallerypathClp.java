 ...
 */
@ProviderType
public class feedforwardgallerypathClp extends BaseModelImpl<feedforwardgallerypath>
	implements feedforwardgallerypath {
	public feedforwardgallerypathClp() {
	}
	...
	public void setId(long id) {
		...
		if (_feedforwardgallerypathRemoteModel != null) {
			try {
				Class<?> clazz = _feedforwardgallerypathRemoteModel.getClass();

				Method method = clazz.getMethod("setId", long.class);

				method.invoke(_feedforwardgallerypathRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setAlbumId(String albumId) {
		...
		if (_feedforwardgallerypathRemoteModel != null) {
			try {
				...
				method.invoke(_feedforwardgallerypathRemoteModel, albumId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setAlbumImagePath(String albumImagePath) {
		...
		if (_feedforwardgallerypathRemoteModel != null) {
			try {
				...
				method.invoke(_feedforwardgallerypathRemoteModel, albumImagePath);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setImageTitle(String imageTitle) {
		...
		if (_feedforwardgallerypathRemoteModel != null) {
			try {
				...
				method.invoke(_feedforwardgallerypathRemoteModel, imageTitle);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCreatedDate(Date createdDate) {
		...
		if (_feedforwardgallerypathRemoteModel != null) {
			try {
				...
				method.invoke(_feedforwardgallerypathRemoteModel, createdDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCreatedBy(String createdBy) {
		...
		if (_feedforwardgallerypathRemoteModel != null) {
			try {
				...
				method.invoke(_feedforwardgallerypathRemoteModel, createdBy);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUpdatedDate(Date updatedDate) {
		...
		if (_feedforwardgallerypathRemoteModel != null) {
			try {
				...
				method.invoke(_feedforwardgallerypathRemoteModel, updatedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUpdatedBy(String updatedBy) {
		...
		if (_feedforwardgallerypathRemoteModel != null) {
			try {
				...
				method.invoke(_feedforwardgallerypathRemoteModel, updatedBy);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setFlag(String flag) {
		...
		if (_feedforwardgallerypathRemoteModel != null) {
			try {
				...
				method.invoke(_feedforwardgallerypathRemoteModel, flag);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setContent_id(long content_id) {
		...
		if (_feedforwardgallerypathRemoteModel != null) {
			try {
				...
				method.invoke(_feedforwardgallerypathRemoteModel, content_id);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getfeedforwardgallerypathRemoteModel() {
		return _feedforwardgallerypathRemoteModel;
	}

	public void setfeedforwardgallerypathRemoteModel(
		BaseModel<?> feedforwardgallerypathRemoteModel) {
		_feedforwardgallerypathRemoteModel = feedforwardgallerypathRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _feedforwardgallerypathRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_feedforwardgallerypathRemoteModel,
	...
	public void persist() {
		if (this.isNew()) {
			feedforwardgallerypathLocalServiceUtil.addfeedforwardgallerypath(this);
		}
		else {
			feedforwardgallerypathLocalServiceUtil.updatefeedforwardgallerypath(this);
		}
	}

	@Override
	public feedforwardgallerypath toEscapedModel() {
		return (feedforwardgallerypath)ProxyUtil.newProxyInstance(feedforwardgallerypath.class.getClassLoader(),
			new Class[] { feedforwardgallerypath.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		feedforwardgallerypathClp clone = new feedforwardgallerypathClp();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof feedforwardgallerypathClp)) {
			return false;
		}

		feedforwardgallerypathClp feedforwardgallerypath = (feedforwardgallerypathClp)obj;
	...
	private BaseModel<?> _feedforwardgallerypathRemoteModel;
