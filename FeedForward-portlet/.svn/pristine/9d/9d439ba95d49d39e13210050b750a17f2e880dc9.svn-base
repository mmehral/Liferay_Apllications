...
import com.chola.feedforward.service.feedforwardgalleryusersService;
...
/**
 * Provides the base implementation for the feedforwardgalleryusers remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.chola.feedforward.service.impl.feedforwardgalleryusersServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class feedforwardgalleryusersServiceBaseImpl
	extends BaseServiceImpl implements feedforwardgalleryusersService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.chola.feedforward.service.feedforwardgalleryusersServiceUtil} to access the feedforwardgalleryusers remote service.
	 */
	...
	/**
	 * Returns the feedforwardgallery remote service.
	 *
	 * @return the feedforwardgallery remote service
	 */
	public com.chola.feedforward.service.feedforwardgalleryService getfeedforwardgalleryService() {
		return feedforwardgalleryService;
	}

	/**
	 * Sets the feedforwardgallery remote service.
	 *
	 * @param feedforwardgalleryService the feedforwardgallery remote service
	 */
	public void setfeedforwardgalleryService(
		com.chola.feedforward.service.feedforwardgalleryService feedforwardgalleryService) {
		this.feedforwardgalleryService = feedforwardgalleryService;
	}
	...
	/**
	 * Returns the feedforwardgallerypath remote service.
	 *
	 * @return the feedforwardgallerypath remote service
	 */
	public com.chola.feedforward.service.feedforwardgallerypathService getfeedforwardgallerypathService() {
		return feedforwardgallerypathService;
	}

	/**
	 * Sets the feedforwardgallerypath remote service.
	 *
	 * @param feedforwardgallerypathService the feedforwardgallerypath remote service
	 */
	public void setfeedforwardgallerypathService(
		com.chola.feedforward.service.feedforwardgallerypathService feedforwardgallerypathService) {
		this.feedforwardgallerypathService = feedforwardgallerypathService;
	}
	 ...
	 */
	public com.chola.feedforward.service.feedforwardgalleryusersLocalService getfeedforwardgalleryusersLocalService() {
	...
	public void setfeedforwardgalleryusersLocalService(
		com.chola.feedforward.service.feedforwardgalleryusersLocalService feedforwardgalleryusersLocalService) {
		this.feedforwardgalleryusersLocalService = feedforwardgalleryusersLocalService;
	}

	/**
	 * Returns the feedforwardgalleryusers remote service.
	 *
	 * @return the feedforwardgalleryusers remote service
	 */
	public feedforwardgalleryusersService getfeedforwardgalleryusersService() {
		return feedforwardgalleryusersService;
	}

	/**
	 * Sets the feedforwardgalleryusers remote service.
	 *
	 * @param feedforwardgalleryusersService the feedforwardgalleryusers remote service
	 */
	public void setfeedforwardgalleryusersService(
		feedforwardgalleryusersService feedforwardgalleryusersService) {
		this.feedforwardgalleryusersService = feedforwardgalleryusersService;
	}
	...
	public String getOSGiServiceIdentifier() {
		return feedforwardgalleryusersService.class.getName();
	}
	...
	@BeanReference(type = com.chola.feedforward.service.feedforwardgalleryService.class)
	protected com.chola.feedforward.service.feedforwardgalleryService feedforwardgalleryService;
	...
	@BeanReference(type = com.chola.feedforward.service.feedforwardgallerypathService.class)
	protected com.chola.feedforward.service.feedforwardgallerypathService feedforwardgallerypathService;
	...
	@BeanReference(type = com.chola.feedforward.service.feedforwardgalleryusersLocalService.class)
	protected com.chola.feedforward.service.feedforwardgalleryusersLocalService feedforwardgalleryusersLocalService;
	@BeanReference(type = feedforwardgalleryusersService.class)
	protected feedforwardgalleryusersService feedforwardgalleryusersService;
	...
	private feedforwardgalleryusersServiceClpInvoker _clpInvoker = new feedforwardgalleryusersServiceClpInvoker();
}