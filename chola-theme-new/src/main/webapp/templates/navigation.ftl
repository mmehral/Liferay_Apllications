...
<nav class="navbar navbar-inverse">
  <div class="container-fluid margin-left-15">
      ...
      <ul aria-label="<@liferay.language key="site-pages" />" role="menubar"  class="nav navbar-nav">
		<#list nav_items as nav_item>
			...
			<li ${nav_item_attr_selected} class="${nav_item_css_class}" id="layout_${nav_item.getLayoutId()}" role="presentation">
				<a aria-labelledby="layout_${nav_item.getLayoutId()}" ${nav_item_attr_has_popup} ${nav_item.getTarget()} role="menuitem"><span><@liferay_theme["layout-icon"] layout=nav_item_layout /> ${nav_item.getName()}</span>
			...
			<li><span class="line_nav">|</span></li>
			</#if>
...
/*$( ".dropdown-submenu" ).click(function(event) {
    ...
    $( this ).parents(".dropdown-submenu").addClass('close');
