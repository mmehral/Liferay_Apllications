...
Event To : <input type="text"   name="eventto"><br><br> -->
		...
		<div id="lbdiv">
			...
			Description :<liferay-ui:input-editor name="lbDesc" initMethod="initEditor"
...
<script>
		function getvalidation() {
			...
			var businessTitle=document.getElementById("<portlet:namespace/>lbtitle").value;
			var businessDescription=document.getElementById("<portlet:namespace/>lbDesc").value;
