...
/**
 * Provides the local service interface for lbdetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author cloverliferay01
 * @see lbdetailsLocalServiceUtil
...
public interface lbdetailsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link lbdetailsLocalServiceUtil} to access the lbdetails local service. Add custom service methods to {@link com.chola.learningbites.service.impl.lbdetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<lbdetails> getLBDetails(long contentId);
