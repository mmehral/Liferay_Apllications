...
public class lbdetailsModelImpl extends BaseModelImpl<lbdetails>
	...
	public static final String ORDER_BY_JPQL = " ORDER BY lbdetails.createddate DESC";
	public static final String ORDER_BY_SQL = " ORDER BY chola_lbdetails.createddate DESC";
