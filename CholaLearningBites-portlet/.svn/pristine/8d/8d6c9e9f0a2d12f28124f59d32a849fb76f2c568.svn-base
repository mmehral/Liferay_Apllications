 ...
 */
@ProviderType
public class lbusersLocalServiceClp implements lbusersLocalService {
	public lbusersLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName4 = "fetchlbusers";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "getlbusers";

		_methodParameterTypes5 = new String[] { "long" };

		_methodName6 = "updatelbusers";
		...
		_methodName12 = "getlbusersesCount";
		...
		_methodName18 = "getLBDetails";

		_methodParameterTypes18 = new String[] { "long" };

		_methodName19 = "getLBUsers";

		_methodParameterTypes19 = new String[] { "long" };

		_methodName20 = "getlbuserses";
	...
	public com.chola.learningbites.model.lbusers addlbusers(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(lbusers) });
		}
		catch (Throwable t) {
		...
		return (com.chola.learningbites.model.lbusers)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.chola.learningbites.model.lbusers> getLBDetails(
		...
		return (java.util.List<com.chola.learningbites.model.lbusers>)ClpSerializer.translateOutput(returnObj);
	}
