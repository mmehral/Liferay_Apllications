...
public class mappingLocalServiceClp implements mappingLocalService {
	public mappingLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName5 = "addmapping";

		_methodParameterTypes5 = new String[] { "com.model.mapping" };

		_methodName6 = "createmapping";

		_methodParameterTypes6 = new String[] { "long" };

		_methodName7 = "deletemapping";

		_methodParameterTypes7 = new String[] { "com.model.mapping" };

		_methodName8 = "deletemapping";

		_methodParameterTypes8 = new String[] { "long" };

		_methodName9 = "fetchmapping";

		_methodParameterTypes9 = new String[] { "long" };

		_methodName10 = "getmapping";

		_methodParameterTypes10 = new String[] { "long" };

		_methodName11 = "updatemapping";

		_methodParameterTypes11 = new String[] { "com.model.mapping" };
	...
	public com.model.mapping addmapping(com.model.mapping mapping) {
		...
		return (com.model.mapping)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.model.mapping createmapping(long mapping_id) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName6,
					_methodParameterTypes6, new Object[] { mapping_id });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.model.mapping deletemapping(long mapping_id)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName8,
					_methodParameterTypes8, new Object[] { mapping_id });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.model.mapping fetchmapping(long mapping_id) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { mapping_id });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.model.mapping getmapping(long mapping_id)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { mapping_id });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.model.mapping> getmappings(int start, int end) {
		...
		return (java.util.List<com.model.mapping>)ClpSerializer.translateOutput(returnObj);
	}
