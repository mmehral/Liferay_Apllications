...
public class branchdetailsWrapper implements branchdetails,
	...
	@Override
	public com.chola.listbranch.model.branchdetails toEscapedModel() {
		return new branchdetailsWrapper(_branchdetails.toEscapedModel());
	}

	@Override
	public com.chola.listbranch.model.branchdetails toUnescapedModel() {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<com.chola.listbranch.model.branchdetails> toCacheModel() {
		return _branchdetails.toCacheModel();
	}

	@Override
	public int compareTo(com.chola.listbranch.model.branchdetails branchdetails) {
