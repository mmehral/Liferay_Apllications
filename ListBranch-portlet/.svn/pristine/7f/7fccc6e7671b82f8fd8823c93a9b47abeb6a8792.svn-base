...
public class stateWrapper implements state, ModelWrapper<state> {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<com.model.state> toCacheModel() {
		return _state.toCacheModel();
	}

	@Override
	public com.model.state toEscapedModel() {
		return new stateWrapper(_state.toEscapedModel());
	}

	@Override
	public com.model.state toUnescapedModel() {
		return new stateWrapper(_state.toUnescapedModel());
	}

	@Override
	public int compareTo(com.model.state state) {
