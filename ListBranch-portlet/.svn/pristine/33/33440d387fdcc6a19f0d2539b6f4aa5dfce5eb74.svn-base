 ...
 * @see com.service.persistence.impl.statePersistenceImpl
 * @generated
 */
@ProviderType
public class stateUtil {
	...
	*/
	public static state remove(long state_id)
		throws com.exception.NoSuchstateException {
	...
	*/
	...
	public static statePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (statePersistence)PortletBeanLocatorUtil.locate(com.service.ClpSerializer.getServletContextName(),
