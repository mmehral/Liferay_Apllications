...
import com.chola.listbranch.exception.NoSuchmappingException;
import com.chola.listbranch.model.mapping;

import com.liferay.portal.kernel.service.persistence.BasePersistence;

/**
 * The persistence interface for the mapping service.
 *
 * <p>
 ...
 */
@ProviderType
public interface mappingPersistence extends BasePersistence<mapping> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link mappingUtil} to access the mapping persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<mapping> mappings);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, mapping> fetchByPrimaryKeys(
	...
	* @return the mappings
	*/
	public java.util.List<mapping> findAll();
	...
	*/
	public java.util.List<mapping> findAll(int start, int end);
	...
	*/
	public java.util.List<mapping> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<mapping> orderByComparator);
