...
/**
 * This class is used by SOAP remote services, specifically {@link com.chola.listbranch.service.http.productServiceSoap}.
 *
 * @author adms.java1
 * @see com.chola.listbranch.service.http.productServiceSoap
 * @generated
 */
@ProviderType
