 ...
 * @generated
 */
@ImplementationClassName("com.model.impl.branchdetailsImpl")
@ProviderType
public interface branchdetails extends branchdetailsModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link com.model.impl.branchdetailsImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
