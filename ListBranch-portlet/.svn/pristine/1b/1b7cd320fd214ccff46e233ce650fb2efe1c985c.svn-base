 ...
 * @see com.chola.listbranch.service.persistence.impl.statePersistenceImpl
 * @generated
 */
@ProviderType
public class stateUtil {
	...
	*/
	public static state remove(long state_id)
		throws com.chola.listbranch.exception.NoSuchstateException {
	...
	*/
	...
	public static statePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (statePersistence)PortletBeanLocatorUtil.locate(com.chola.listbranch.service.ClpSerializer.getServletContextName(),
