...
public class productWrapper implements product, ModelWrapper<product> {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<com.model.product> toCacheModel() {
		return _product.toCacheModel();
	}

	@Override
	public com.model.product toEscapedModel() {
		return new productWrapper(_product.toEscapedModel());
	}

	@Override
	public com.model.product toUnescapedModel() {
		return new productWrapper(_product.toUnescapedModel());
	}

	@Override
	public int compareTo(com.model.product product) {
