 ...
 * @author adms.java1
 * @see stateModel
 * @see com.model.impl.stateImpl
 * @see com.model.impl.stateModelImpl
 * @generated
 */
@ImplementationClassName("com.model.impl.stateImpl")
@ProviderType
public interface state extends stateModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link com.model.impl.stateImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
