 ...
 * {@link com.chola.listbranch.service.impl.cityLocalServiceImpl} and is the
 ...
 * @see com.chola.listbranch.service.base.cityLocalServiceBaseImpl
 * @see com.chola.listbranch.service.impl.cityLocalServiceImpl
 * @generated
 */
@ProviderType
public class cityLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.chola.listbranch.service.impl.cityLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.chola.listbranch.model.city addcity(
	...
	* @return the new city
	*/
	public static com.chola.listbranch.model.city createcity(long city_id) {
		return getService().createcity(city_id);
	}
	...
	*/
	public static com.chola.listbranch.model.city deletecity(
		com.chola.listbranch.model.city city) {
	...
	*/
	public static com.chola.listbranch.model.city deletecity(long city_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deletecity(city_id);
	}

	public static com.chola.listbranch.model.city fetchcity(long city_id) {
		return getService().fetchcity(city_id);
	}
	...
	* @throws PortalException if a city with the primary key could not be found
	*/
	public static com.chola.listbranch.model.city getcity(long city_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getcity(city_id);
	}
	...
	*/
	public static com.chola.listbranch.model.city updatecity(
		com.chola.listbranch.model.city city) {
	...
	*/
	...
	public static java.lang.String getbranchName(long branchId) {
		return getService().getbranchName(branchId);
	}

	public static java.lang.String getcityName(long cityId) {
		return getService().getcityName(cityId);
	}

	public static java.lang.String getproductName(long productId) {
		return getService().getproductName(productId);
	}
	...
	*/
	...
	public static java.util.List getBranchNamedetails(long cityId) {
		return getService().getBranchNamedetails(cityId);
	}

	public static java.util.List<java.lang.String> getCities(long stateID) {
		return getService().getCities(stateID);
	}
	...
	*/
	public static java.util.List<com.chola.listbranch.model.city> getcities(
		int start, int end) {
