 ...
 * @see com.chola.listbranch.service.persistence.impl.productPersistenceImpl
 * @generated
 */
@ProviderType
public class productUtil {
	...
	*/
	public static product remove(long product_id)
		throws com.chola.listbranch.exception.NoSuchproductException {
	...
	*/
	...
	public static productPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (productPersistence)PortletBeanLocatorUtil.locate(com.chola.listbranch.service.ClpSerializer.getServletContextName(),
