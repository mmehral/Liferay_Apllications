...
public class cityUtil {
	...
	*/
	public static city remove(long city_id)
		throws com.exception.NoSuchcityException {
	...
	*/
	...
	public static cityPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (cityPersistence)PortletBeanLocatorUtil.locate(com.service.ClpSerializer.getServletContextName(),
