...
/**
 * Provides the local service interface for sspath. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author cloverliferay01
 * @see sspathLocalServiceUtil
...
public interface sspathLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link sspathLocalServiceUtil} to access the sspath local service. Add custom service methods to {@link com.chola.successstories.service.impl.sspathLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public sspath addsspath(sspath sspath);
	...
	*/
	public sspath createsspath(long id);
	...
	*/
	...
	public sspath deletesspath(sspath sspath);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public sspath deletesspath(long id) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public sspath fetchsspath(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public sspath getsspath(long id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public sspath updatesspath(sspath sspath);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<sspath> getSuccessStoriesDetails(long content_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<sspath> getsspaths(int start, int end);
