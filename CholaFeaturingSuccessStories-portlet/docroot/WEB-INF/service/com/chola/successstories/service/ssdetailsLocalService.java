...
/**
 * Provides the local service interface for ssdetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author cloverliferay01
 * @see ssdetailsLocalServiceUtil
...
public interface ssdetailsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ssdetailsLocalServiceUtil} to access the ssdetails local service. Add custom service methods to {@link com.chola.successstories.service.impl.ssdetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
