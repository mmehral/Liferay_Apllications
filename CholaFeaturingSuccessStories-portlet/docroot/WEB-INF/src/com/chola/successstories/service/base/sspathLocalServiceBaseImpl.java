...
import com.chola.successstories.service.sspathLocalService;
...
/**
 * Provides the base implementation for the sspath local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.chola.successstories.service.impl.sspathLocalServiceImpl}.
 * </p>
 *
 * @author cloverliferay01
 * @see com.chola.successstories.service.impl.sspathLocalServiceImpl
 * @see com.chola.successstories.service.sspathLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class sspathLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements sspathLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.chola.successstories.service.sspathLocalServiceUtil} to access the sspath local service.
	 */
	...
	public sspath addsspath(sspath sspath) {
		...
		return sspathPersistence.update(sspath);
	}
	...
	public sspath createsspath(long id) {
		return sspathPersistence.create(id);
	}
	...
	public sspath deletesspath(long id) throws PortalException {
		return sspathPersistence.remove(id);
	}
	...
	public sspath deletesspath(sspath sspath) {
		return sspathPersistence.remove(sspath);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(sspath.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sspathPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return sspathPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sspathPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return sspathPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public sspath fetchsspath(long id) {
		return sspathPersistence.fetchByPrimaryKey(id);
	}
	...
	public sspath getsspath(long id) throws PortalException {
		return sspathPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(sspathLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(sspath.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(sspathLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(sspath.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return sspathLocalService.deletesspath((sspath)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return sspathPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<sspath> getsspaths(int start, int end) {
		return sspathPersistence.findAll(start, end);
	}
	...
	public int getsspathsCount() {
		return sspathPersistence.countAll();
	}
	 ...
	 */
	public sspathLocalService getsspathLocalService() {
	 ...
	 */
	public void setsspathLocalService(sspathLocalService sspathLocalService) {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.chola.successstories.model.sspath",
			sspathLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return sspathLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = sspathPersistence.getDataSource();
	...
	@BeanReference(type = sspathLocalService.class)
	protected sspathLocalService sspathLocalService;
	...
	private sspathLocalServiceClpInvoker _clpInvoker = new sspathLocalServiceClpInvoker();
}