...
/**
 * The persistence interface for the swagatam service.
 *
 * <p>
 ...
 */
@ProviderType
public interface swagatamPersistence extends BasePersistence<swagatam> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link swagatamUtil} to access the swagatam persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<swagatam> swagatams);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, swagatam> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<swagatam> findAll();
	...
	*/
	public java.util.List<swagatam> findAll(int start, int end);
	...
	*/
	public java.util.List<swagatam> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<swagatam> orderByComparator);
