...
/**
 * Provides the local service interface for swagatampath. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author CloverLiferay02
 * @see swagatampathLocalServiceUtil
 * @see com.chola.swagatam.service.base.swagatampathLocalServiceBaseImpl
...
public interface swagatampathLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link swagatampathLocalServiceUtil} to access the swagatampath local service. Add custom service methods to {@link com.chola.swagatam.service.impl.swagatampathLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<swagatampath> getVideoDetails(java.lang.String albumId);
