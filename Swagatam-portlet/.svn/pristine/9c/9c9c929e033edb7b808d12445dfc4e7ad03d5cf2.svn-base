...
/**
 * Provides the local service interface for swagatam. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author CloverLiferay02
 * @see swagatamLocalServiceUtil
...
public interface swagatamLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link swagatamLocalServiceUtil} to access the swagatam local service. Add custom service methods to {@link com.chola.swagatam.service.impl.swagatamLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
