 ...
 * @see com.chola.news.service.persistence.impl.LatestIndustryNewsPersistenceImpl
 * @generated
 */
@ProviderType
public class LatestIndustryNewsUtil {
	...
	*/
	public static LatestIndustryNews remove(long id)
		throws com.chola.news.exception.NoSuchLatestIndustryNewsException {
	...
	*/
	...
	public static LatestIndustryNewsPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (LatestIndustryNewsPersistence)PortletBeanLocatorUtil.locate(com.chola.news.service.ClpSerializer.getServletContextName(),
