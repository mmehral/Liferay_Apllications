...
import com.chola.contest.model.cholacontestModel;
import com.chola.contest.model.cholacontestSoap;
...
public class cholacontestModelImpl extends BaseModelImpl<cholacontest>
	...
	public static final String TABLE_SQL_CREATE = "create table chola_cholacontest (id_ LONG not null primary key,content_id LONG,content VARCHAR(75) null,startdate DATE null,enddate DATE null,feedback VARCHAR(500) null,createDate DATE null,contest_code INTEGER,contest_val INTEGER,contest_desc TEXT null,contest_doc VARCHAR(500) null,contest_path VARCHAR(500) null,contest_title VARCHAR(500) null,user_id VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table chola_cholacontest";
	public static final String ORDER_BY_JPQL = " ORDER BY cholacontest.createDate DESC";
	public static final String ORDER_BY_SQL = " ORDER BY chola_cholacontest.createDate DESC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.chola.contest.model.cholacontest"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.chola.contest.model.cholacontest"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.chola.contest.model.cholacontest"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.chola.contest.model.cholacontest"));
