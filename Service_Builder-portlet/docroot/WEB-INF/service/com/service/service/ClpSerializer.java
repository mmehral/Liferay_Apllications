...
import com.service.model.employeeClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"Service_Builder-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "Service_Builder-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("com.service.model.impl.employeeImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.service.exception.NoSuchemployeeException")) {
			return new com.service.exception.NoSuchemployeeException(throwable.getMessage(),
				throwable.getCause());
		}
