...
/**
 * Provides the local service interface for ContestUserDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author CloverLiferay01
 * @see ContestUserDetailsLocalServiceUtil
...
public interface ContestUserDetailsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ContestUserDetailsLocalServiceUtil} to access the contest user details local service. Add custom service methods to {@link com.contest.service.impl.ContestUserDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
