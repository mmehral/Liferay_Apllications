...
<body>
<%
	List<Object[]> list=CholaContestLocalServiceUtil.syscodeCustomMsg(4);
System.out.println("Syscode List..........."+list);
%>
	...
	<div id="parameters_007">
			...
			<div id="gender_age">
				...
				Male &nbsp;&nbsp;&nbsp; <input type="radio" name="gender"
					...
					type="radio" name="gender" value="both" checked> Both <br>
...
Event To : <input type="text"   name="eventto"><br><br> -->
				...
				Contest : <input type="checkbox" id="checkboxSOPshowhide" name="checkboxSOPshowhide" checked/> 
<div id="contestDiv">
...
<aui:input name="startdate" type="text"  label="Start Date" placeholder="MM-DD-YYYY" helpMessage="Please Enter Start Date">
 <aui:validator name="required" errorMessage="Please Enter Start Date"/>
  <aui:validator name="date"></aui:validator>
</aui:input>

<aui:input name="enddate" type="text"  label="End Date" placeholder="MM-DD-YYYY" helpMessage="Please Enter End Date">
