 ...
 * @see postPersistence
 * @see com.chola.app.service.persistence.impl.postPersistenceImpl
 * @generated
 */
@ProviderType
public class postUtil {
	...
	*/
	public static post remove(long id)
		throws com.chola.app.exception.NoSuchpostException {
	...
	*/
	...
	public static postPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (postPersistence)PortletBeanLocatorUtil.locate(com.chola.app.service.ClpSerializer.getServletContextName(),
