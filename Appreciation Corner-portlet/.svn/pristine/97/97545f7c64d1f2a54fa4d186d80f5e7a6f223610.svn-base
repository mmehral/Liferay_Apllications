...
import com.chola.app.service.postService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.chola.app.service.impl.postServiceImpl}.
 * </p>
 *
...
public abstract class postServiceBaseImpl extends BaseServiceImpl
	implements postService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.chola.app.service.postServiceUtil} to access the post remote service.
	 */
	 ...
	 */
	public com.chola.app.service.repliedService getrepliedService() {
	 ...
	 */
	public void setrepliedService(
		com.chola.app.service.repliedService repliedService) {
	...
	@BeanReference(type = com.chola.app.service.repliedService.class)
	protected com.chola.app.service.repliedService repliedService;
