...
/**
 * The base model interface for the replied service. Represents a row in the &quot;appreciation_replied&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.chola.app.model.impl.repliedModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.chola.app.model.impl.repliedImpl}.
 * </p>
 *
...
public interface repliedModel extends BaseModel<replied> {
	...
	@Override
	public CacheModel<com.chola.app.model.replied> toCacheModel();
