...
public class repliedWrapper implements replied, ModelWrapper<replied> {
	...
	@Override
	public com.chola.app.model.replied toEscapedModel() {
		return new repliedWrapper(_replied.toEscapedModel());
	}

	@Override
	public com.chola.app.model.replied toUnescapedModel() {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<com.chola.app.model.replied> toCacheModel() {
		return _replied.toCacheModel();
	}

	@Override
	public int compareTo(com.chola.app.model.replied replied) {
	...
	*/
	@Override
	public java.lang.String getRepliedBy() {
	...
	*/
	@Override
	public java.lang.String getRepliedTo() {
	...
	*/
	@Override
	public void setRepliedBy(java.lang.String repliedBy) {
	...
	*/
	@Override
	public void setRepliedTo(java.lang.String repliedTo) {
