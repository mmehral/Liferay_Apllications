 ...
 */
@ProviderType
public class cholatalkiespathLocalServiceClp
	implements cholatalkiespathLocalService {
	public cholatalkiespathLocalServiceClp(
		...
		_methodName5 = "addcholatalkiespath";

		_methodParameterTypes5 = new String[] { "com.model.cholatalkiespath" };

		_methodName6 = "createcholatalkiespath";

		_methodParameterTypes6 = new String[] { "long" };

		_methodName7 = "deletecholatalkiespath";

		_methodParameterTypes7 = new String[] { "com.model.cholatalkiespath" };

		_methodName8 = "deletecholatalkiespath";

		_methodParameterTypes8 = new String[] { "long" };

		_methodName9 = "fetchcholatalkiespath";

		_methodParameterTypes9 = new String[] { "long" };

		_methodName10 = "getcholatalkiespath";

		_methodParameterTypes10 = new String[] { "long" };

		_methodName11 = "updatecholatalkiespath";

		_methodParameterTypes11 = new String[] { "com.model.cholatalkiespath" };

		_methodName12 = "getcholatalkiespathsCount";
		...
		_methodName19 = "getcholatalkiespaths";
	...
	public com.model.cholatalkiespath addcholatalkiespath(
		...
		return (com.model.cholatalkiespath)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.model.cholatalkiespath> cholaTalkiesVideoDetails(
		...
		return (java.util.List<com.model.cholatalkiespath>)ClpSerializer.translateOutput(returnObj);
	}
