...
/**
 * Provides the local service interface for cholatalkiespath. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author adms.java1
 * @see cholatalkiespathLocalServiceUtil
...
public interface cholatalkiespathLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link cholatalkiespathLocalServiceUtil} to access the cholatalkiespath local service. Add custom service methods to {@link com.service.impl.cholatalkiespathLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public cholatalkiespath addcholatalkiespath(
	...
	*/
	public cholatalkiespath createcholatalkiespath(long id);
	...
	*/
	...
	public cholatalkiespath deletecholatalkiespath(
		cholatalkiespath cholatalkiespath);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public cholatalkiespath deletecholatalkiespath(long id)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public cholatalkiespath fetchcholatalkiespath(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public cholatalkiespath getcholatalkiespath(long id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public cholatalkiespath updatecholatalkiespath(
		cholatalkiespath cholatalkiespath);
	...
	*/
	...
	public List<cholatalkiespath> cholaTalkiesVideoDetails(long contentId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<cholatalkiespath> getcholatalkiespaths(int start, int end);
