...
/**
 * Provides the local service interface for cholatalkiesusers. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author adms.java1
 * @see cholatalkiesusersLocalServiceUtil
...
public interface cholatalkiesusersLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link cholatalkiesusersLocalServiceUtil} to access the cholatalkiesusers local service. Add custom service methods to {@link com.service.impl.cholatalkiesusersLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
