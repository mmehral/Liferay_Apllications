...
/**
 * Provides the local service interface for cholatalkies. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author adms.java1
 * @see cholatalkiesLocalServiceUtil
...
public interface cholatalkiesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link cholatalkiesLocalServiceUtil} to access the cholatalkies local service. Add custom service methods to {@link com.service.impl.cholatalkiesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
