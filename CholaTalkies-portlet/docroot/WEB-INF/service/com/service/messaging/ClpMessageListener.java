...
import com.service.cholatalkiesServiceUtil;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			cholatalkiesLocalServiceUtil.clearService();

			cholatalkiesServiceUtil.clearService();
			cholatalkiespathLocalServiceUtil.clearService();

			cholatalkiespathServiceUtil.clearService();
		}
	}
}