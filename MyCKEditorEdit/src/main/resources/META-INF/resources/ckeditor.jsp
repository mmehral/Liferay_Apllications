...
if (data != null) {
	...
	System.out.println("Ck Editor Config : "+editorConfigJSONObject.toString());
	 JSONArray addButtons = editorConfigJSONObject.getJSONArray("toolbar_liferay");
	 addButtons.put("SpellChecker"); 
	 
	 System.out.println("Ck Editor Config after Change : "+addButtons.toString());
}
