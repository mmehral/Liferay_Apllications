...
import Calendar.MicrosoftExchangeSync.constants.CalendarMicrosoftExchangeSyncPortletKeys;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Calendar-MicrosoftExchangeSync Portlet",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view.jsp",
		"javax.portlet.name=" + CalendarMicrosoftExchangeSyncPortletKeys.CalendarMicrosoftExchangeSync,
...
public class CalendarMicrosoftExchangeSyncPortlet extends MVCPortlet {
...
private static final Log _log = LogFactoryUtil.getLog(CalendarMicrosoftExchangeSyncPortlet.class);
