...
/**
 * Provides the local service interface for floorwing. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author adms.java1
 * @see floorwingLocalServiceUtil
...
public interface floorwingLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link floorwingLocalServiceUtil} to access the floorwing local service. Add custom service methods to {@link com.chola.service.conference.service.impl.floorwingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
