...
/**
 * Provides the local service interface for conferenceroombookingdetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author adms.java1
 * @see conferenceroombookingdetailsLocalServiceUtil
...
public interface conferenceroombookingdetailsLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link conferenceroombookingdetailsLocalServiceUtil} to access the conferenceroombookingdetails local service. Add custom service methods to {@link com.chola.conferenceroombooking.service.impl.conferenceroombookingdetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public conferenceroombookingdetails addconferenceroombookingdetails(
	...
	*/
	public conferenceroombookingdetails createconferenceroombookingdetails(
		long bookid);
	...
	*/
	...
	public conferenceroombookingdetails deleteconferenceroombookingdetails(
		conferenceroombookingdetails conferenceroombookingdetails);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public conferenceroombookingdetails deleteconferenceroombookingdetails(
		long bookid) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public conferenceroombookingdetails fetchconferenceroombookingdetails(
		long bookid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public conferenceroombookingdetails getconferenceroombookingdetails(
		long bookid) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public conferenceroombookingdetails updateconferenceroombookingdetails(
		conferenceroombookingdetails conferenceroombookingdetails);
	...
	*/
	...
	public List<java.lang.Object[]> allBookingList(java.lang.String startdate,
		java.lang.String endate, java.lang.String stateid,
		java.lang.String locid);

	public List<java.lang.Object[]> conferenceroom(int stateid, int locationid);

	public List<java.lang.Object[]> defaultallBookingList(
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<java.lang.Object[]> getConferenceList(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<conferenceroombookingdetails> getconferenceroombookingdetailses(
		int start, int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<java.lang.Long> getroomId(int stateid, int locid);

	public List<java.lang.Object[]> location(int stateid);

	public List<java.lang.Object[]> mybookinglist(long userid, int status);

	public List<java.lang.Object[]> state();
