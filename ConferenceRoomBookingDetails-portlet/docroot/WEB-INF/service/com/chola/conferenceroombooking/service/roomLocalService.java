...
public interface roomLocalService extends BaseLocalService, InvokableLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link roomLocalServiceUtil} to access the room local service. Add custom service methods to {@link com.chola.conferenceroombooking.service.impl.roomLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	* @return the new room
	*/
	public room createroom(long room_id);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public room deleteroom(long room_id) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public room fetchroom(long room_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public room getroom(long room_id) throws PortalException;
