 ...
 * {@link com.chola.conferenceroombooking.service.impl.stateLocalServiceImpl} and is the
 ...
 * @see com.chola.conferenceroombooking.service.base.stateLocalServiceBaseImpl
 * @see com.chola.conferenceroombooking.service.impl.stateLocalServiceImpl
 * @generated
 */
@ProviderType
public class stateLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.chola.conferenceroombooking.service.impl.stateLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.chola.conferenceroombooking.model.state addstate(
	...
	*/
	public static com.chola.conferenceroombooking.model.state createstate(
		long state_id) {
		return getService().createstate(state_id);
	}
	...
	*/
	public static com.chola.conferenceroombooking.model.state deletestate(
		com.chola.conferenceroombooking.model.state state) {
	...
	*/
	public static com.chola.conferenceroombooking.model.state deletestate(
		...
		return getService().deletestate(state_id);
	}

	public static com.chola.conferenceroombooking.model.state fetchstate(
		long state_id) {
		return getService().fetchstate(state_id);
	}
	...
	* @throws PortalException if a state with the primary key could not be found
	*/
	public static com.chola.conferenceroombooking.model.state getstate(
		long state_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getstate(state_id);
	}
	...
	*/
	public static com.chola.conferenceroombooking.model.state updatestate(
		com.chola.conferenceroombooking.model.state state) {
	...
	*/
	public static java.util.List<com.chola.conferenceroombooking.model.state> getstates(
		int start, int end) {
