...
public class stateWrapper implements state, ModelWrapper<state> {
	...
	@Override
	public com.chola.conferenceroombooking.model.state toEscapedModel() {
		return new stateWrapper(_state.toEscapedModel());
	}

	@Override
	public com.chola.conferenceroombooking.model.state toUnescapedModel() {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<com.chola.conferenceroombooking.model.state> toCacheModel() {
		return _state.toCacheModel();
	}

	@Override
	public int compareTo(com.chola.conferenceroombooking.model.state state) {
