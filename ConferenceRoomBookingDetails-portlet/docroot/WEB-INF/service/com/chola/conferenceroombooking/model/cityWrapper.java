...
public class cityWrapper implements city, ModelWrapper<city> {
	...
	@Override
	public com.chola.conferenceroombooking.model.city toEscapedModel() {
		return new cityWrapper(_city.toEscapedModel());
	}

	@Override
	public com.chola.conferenceroombooking.model.city toUnescapedModel() {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<com.chola.conferenceroombooking.model.city> toCacheModel() {
		return _city.toCacheModel();
	}

	@Override
	public int compareTo(com.chola.conferenceroombooking.model.city city) {
