...
/**
 * The extended model base implementation for the post service. Represents a row in the &quot;appcorner_post&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
