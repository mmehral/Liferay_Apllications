...
public class repliedLocalServiceClp implements repliedLocalService {
	public repliedLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName18 = "getRepliedData";

		_methodParameterTypes18 = new String[] { "long" };

		_methodName19 = "getreplieds";
	...
	public com.chola.appcorner.model.replied addreplied(
		...
		return (com.chola.appcorner.model.replied)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.chola.appcorner.model.replied> getRepliedData(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName18,
					_methodParameterTypes18, new Object[] { postId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
		...
		return (java.util.List<com.chola.appcorner.model.replied>)ClpSerializer.translateOutput(returnObj);
	}
