	...
	public void setRepliedTo(long repliedTo) {
		...
		if (_repliedRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setRepliedTo", long.class);
	...
	public void setRepliedBy(long repliedBy) {
		...
		if (_repliedRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setRepliedBy", long.class);
	...
	public void setRepliedDate(String repliedDate) {
		...
		if (_repliedRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setRepliedDate", String.class);
