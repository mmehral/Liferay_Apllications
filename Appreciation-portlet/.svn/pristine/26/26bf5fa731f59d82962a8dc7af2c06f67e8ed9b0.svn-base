...
public class postWrapper implements post, ModelWrapper<post> {
	...
	@Override
	public com.chola.appcorner.model.post toEscapedModel() {
		return new postWrapper(_post.toEscapedModel());
	}

	@Override
	public com.chola.appcorner.model.post toUnescapedModel() {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<com.chola.appcorner.model.post> toCacheModel() {
		return _post.toCacheModel();
	}

	@Override
	public int compareTo(com.chola.appcorner.model.post post) {
