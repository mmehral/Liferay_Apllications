...
public class postCacheModel implements CacheModel<post>, Externalizable {
	...
	public post toEntityModel() {
		...
		if (appDate == null) {
			postImpl.setAppDate(StringPool.BLANK);
		}
		else {
			postImpl.setAppDate(appDate);
		}
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		appTo = objectInput.readLong();

		appBy = objectInput.readLong();
		appMessage = objectInput.readUTF();
		appDate = objectInput.readUTF();
	}
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		objectOutput.writeLong(appTo);

		objectOutput.writeLong(appBy);
