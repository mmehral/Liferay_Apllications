...
public class repliedCacheModel implements CacheModel<replied>, Externalizable {
	...
	public replied toEntityModel() {
		...
		if (repliedDate == null) {
			repliedImpl.setRepliedDate(StringPool.BLANK);
		}
		else {
			repliedImpl.setRepliedDate(repliedDate);
		}
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		repliedTo = objectInput.readLong();

		repliedBy = objectInput.readLong();
		repliedMessage = objectInput.readUTF();
		repliedDate = objectInput.readUTF();
	}
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		objectOutput.writeLong(repliedTo);

		objectOutput.writeLong(repliedBy);
		...
		if (repliedDate == null) {
			...
			objectOutput.writeUTF(repliedDate);
		}
	}
