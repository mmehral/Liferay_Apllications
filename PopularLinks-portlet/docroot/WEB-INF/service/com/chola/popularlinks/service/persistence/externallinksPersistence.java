...
/**
 * The persistence interface for the externallinks service.
 *
 * <p>
 ...
 *
 * @author adms.java1
 * @see com.chola.popularlinks.service.persistence.impl.externallinksPersistenceImpl
 * @see externallinksUtil
 * @generated
 */
@ProviderType
public interface externallinksPersistence extends BasePersistence<externallinks> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link externallinksUtil} to access the externallinks persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<externallinks> externallinkses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, externallinks> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<externallinks> findAll();
	...
	*/
	public java.util.List<externallinks> findAll(int start, int end);
	...
	*/
	public java.util.List<externallinks> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<externallinks> orderByComparator);
