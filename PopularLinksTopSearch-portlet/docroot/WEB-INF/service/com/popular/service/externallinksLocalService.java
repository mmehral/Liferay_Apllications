...
/**
 * Provides the local service interface for externallinks. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author CloverLiferay02
 * @see externallinksLocalServiceUtil
...
public interface externallinksLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link externallinksLocalServiceUtil} to access the externallinks local service. Add custom service methods to {@link com.popular.service.impl.externallinksLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
