 ...
 */
@ProviderType
public class imagegalleryLocalServiceClp implements imagegalleryLocalService {
	public imagegalleryLocalServiceClp(
		...
		_methodName4 = "fetchimagegallery";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "getimagegallery";

		_methodParameterTypes5 = new String[] { "long" };

		_methodName6 = "updateimagegallery";
		...
		_methodName12 = "getimagegalleriesCount";
		...
		_methodName18 = "getimagegalleries";
	...
	public com.chola.imagegallery.model.imagegallery addimagegallery(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(imagegallery) });
		}
		catch (Throwable t) {
		...
		return (com.chola.imagegallery.model.imagegallery)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.chola.imagegallery.model.imagegallery> getimagegalleries(
		...
		return (java.util.List<com.chola.imagegallery.model.imagegallery>)ClpSerializer.translateOutput(returnObj);
	}
