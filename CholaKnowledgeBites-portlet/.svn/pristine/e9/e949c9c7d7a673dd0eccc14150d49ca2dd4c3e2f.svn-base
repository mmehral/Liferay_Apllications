...
/**
 * Provides the local service interface for kbusers. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author cloverliferay01
 * @see kbusersLocalServiceUtil
...
public interface kbusersLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link kbusersLocalServiceUtil} to access the kbusers local service. Add custom service methods to {@link com.chola.knowledgebites.service.impl.kbusersLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<kbusers> getKBDetails(long bookId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<kbusers> getKBUsers(long user_id);
