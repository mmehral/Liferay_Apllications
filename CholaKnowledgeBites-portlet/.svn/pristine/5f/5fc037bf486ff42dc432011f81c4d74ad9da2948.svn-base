...
/**
 * Provides the local service interface for kbdetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author cloverliferay01
 * @see kbdetailsLocalServiceUtil
...
public interface kbdetailsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link kbdetailsLocalServiceUtil} to access the kbdetails local service. Add custom service methods to {@link com.chola.knowledgebites.service.impl.kbdetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
