 ...
 */
@ProviderType
public class kbpathLocalServiceClp implements kbpathLocalService {
	public kbpathLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName4 = "fetchkbpath";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "getkbpath";

		_methodParameterTypes5 = new String[] { "long" };

		_methodName6 = "updatekbpath";
	...
	public com.chola.knowledgebites.model.kbpath addkbpath(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(kbpath) });
		}
		catch (Throwable t) {
		...
		return (com.chola.knowledgebites.model.kbpath)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.chola.knowledgebites.model.kbpath> getKBDetails(
		...
		return (java.util.List<com.chola.knowledgebites.model.kbpath>)ClpSerializer.translateOutput(returnObj);
	}
