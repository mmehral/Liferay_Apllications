...
Event To : <input type="text"   name="eventto"><br><br> -->
		...
		<div id="kbdiv">
			...
			<aui:input type="textarea" name="kbtitle" id="kbtitle" label="Title">
				<aui:validator name="required"></aui:validator>
				 <aui:validator name="maxLength">100</aui:validator>
			</aui:input>

			<%-- <aui:input type="textarea" name="kbDesc" id="kbDesc"
				label="Description">
				<aui:validator name="required"></aui:validator>
				<aui:validator name="maxLength">200</aui:validator>
			</aui:input> --%>
			
			Description :<liferay-ui:input-editor name="kbDesc" initMethod="initEditor"
...
<script>
		function getvalidation() {
			...
			var businessTitle=document.getElementById("<portlet:namespace/>kbtitle").value;
			var businessDescription=document.getElementById("<portlet:namespace/>kbDesc").value;
