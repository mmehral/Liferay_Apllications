...
import com.chola.productbuysell.service.BuySellProductsService;
...
/**
 * Provides the base implementation for the buy sell products remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.chola.productbuysell.service.impl.BuySellProductsServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class BuySellProductsServiceBaseImpl extends BaseServiceImpl
	implements BuySellProductsService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.chola.productbuysell.service.BuySellProductsServiceUtil} to access the buy sell products remote service.
	 */
	...
	/**
	 * Returns the buy sell remote service.
	 *
	 * @return the buy sell remote service
	 */
	public com.chola.productbuysell.service.BuySellService getBuySellService() {
		return buySellService;
	}

	/**
	 * Sets the buy sell remote service.
	 *
	 * @param buySellService the buy sell remote service
	 */
	public void setBuySellService(
		com.chola.productbuysell.service.BuySellService buySellService) {
	...
	/**
	 * Returns the buy sell products remote service.
	 *
	 * @return the buy sell products remote service
	 */
	public BuySellProductsService getBuySellProductsService() {
		return buySellProductsService;
	}

	/**
	 * Sets the buy sell products remote service.
	 *
	 * @param buySellProductsService the buy sell products remote service
	 */
	public void setBuySellProductsService(
		BuySellProductsService buySellProductsService) {
		this.buySellProductsService = buySellProductsService;
	}
	...
	/**
	 * Returns the buy sell products images remote service.
	 *
	 * @return the buy sell products images remote service
	 */
	public com.chola.productbuysell.service.BuySellProductsImagesService getBuySellProductsImagesService() {
		return buySellProductsImagesService;
	}

	/**
	 * Sets the buy sell products images remote service.
	 *
	 * @param buySellProductsImagesService the buy sell products images remote service
	 */
	public void setBuySellProductsImagesService(
		com.chola.productbuysell.service.BuySellProductsImagesService buySellProductsImagesService) {
		this.buySellProductsImagesService = buySellProductsImagesService;
	}
	...
	public String getOSGiServiceIdentifier() {
		return BuySellProductsService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = buySellProductsPersistence.getDataSource();
	...
	@BeanReference(type = com.chola.productbuysell.service.BuySellService.class)
	protected com.chola.productbuysell.service.BuySellService buySellService;
	...
	@BeanReference(type = BuySellProductsService.class)
	protected BuySellProductsService buySellProductsService;
	...
	@BeanReference(type = com.chola.productbuysell.service.BuySellProductsImagesService.class)
	protected com.chola.productbuysell.service.BuySellProductsImagesService buySellProductsImagesService;
	...
	private BuySellProductsServiceClpInvoker _clpInvoker = new BuySellProductsServiceClpInvoker();
}