...
/**
 * Provides the local service interface for Around_World. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author adms.java1
 * @see Around_WorldLocalServiceUtil
...
public interface Around_WorldLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Around_WorldLocalServiceUtil} to access the around_ world local service. Add custom service methods to {@link com.chola.news.service.impl.Around_WorldLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
