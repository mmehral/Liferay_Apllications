 ...
 */
@ProviderType
public class Around_WorldLocalServiceClp implements Around_WorldLocalService {
	public Around_WorldLocalServiceClp(
		...
		_methodName4 = "fetchAround_World";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "getAround_World";

		_methodParameterTypes5 = new String[] { "long" };

		_methodName6 = "updateAround_World";
		...
		_methodName12 = "getAround_WorldsCount";
		...
		_methodName18 = "getAround_Worlds";
	...
	public com.chola.news.model.Around_World addAround_World(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(around_World) });
		}
		catch (Throwable t) {
		...
		return (com.chola.news.model.Around_World)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.chola.news.model.Around_World> getAround_Worlds(
		...
		return (java.util.List<com.chola.news.model.Around_World>)ClpSerializer.translateOutput(returnObj);
	}
