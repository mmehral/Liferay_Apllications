...
public class usersWrapper implements users, ModelWrapper<users> {
	...
	@Override
	public com.chola.promotion.model.users toEscapedModel() {
		return new usersWrapper(_users.toEscapedModel());
	}

	@Override
	public com.chola.promotion.model.users toUnescapedModel() {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<com.chola.promotion.model.users> toCacheModel() {
		return _users.toCacheModel();
	}

	@Override
	public int compareTo(com.chola.promotion.model.users users) {
