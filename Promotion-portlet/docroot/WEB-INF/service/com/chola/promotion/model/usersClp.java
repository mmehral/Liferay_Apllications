...
import com.chola.promotion.service.ClpSerializer;
...
public class usersClp extends BaseModelImpl<users> implements users {
	...
	public void setEmpImagePath(String empImagePath) {
		...
		if (_usersRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setEmpImagePath", String.class);

				method.invoke(_usersRemoteModel, empImagePath);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public Object clone() {
		...
		clone.setEmpImagePath(getEmpImagePath());
