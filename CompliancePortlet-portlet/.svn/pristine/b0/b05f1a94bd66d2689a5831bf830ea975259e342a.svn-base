 ...
 * {@link com.service.compliance.service.impl.complianceLocalServiceImpl} and is the
 ...
 * @see com.service.compliance.service.base.complianceLocalServiceBaseImpl
...
public class complianceLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.service.compliance.service.impl.complianceLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.service.compliance.model.compliance addcompliance(
	...
	*/
	public static com.service.compliance.model.compliance createcompliance(
		long compliance_id) {
		return getService().createcompliance(compliance_id);
	}
	...
	*/
	public static com.service.compliance.model.compliance deletecompliance(
		com.service.compliance.model.compliance compliance) {
	...
	*/
	public static com.service.compliance.model.compliance deletecompliance(
		long compliance_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deletecompliance(compliance_id);
	}

	public static com.service.compliance.model.compliance fetchcompliance(
		long compliance_id) {
		return getService().fetchcompliance(compliance_id);
	}
	...
	* @throws PortalException if a compliance with the primary key could not be found
	*/
	public static com.service.compliance.model.compliance getcompliance(
		long compliance_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getcompliance(compliance_id);
	}
	...
	*/
	public static com.service.compliance.model.compliance updatecompliance(
		com.service.compliance.model.compliance compliance) {
	...
	*/
	public static java.util.List<com.service.compliance.model.compliance> getcompliances(
		int start, int end) {
	...
	*/
	...
	public static complianceLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					complianceLocalService.class.getName());

			if (invokableLocalService instanceof complianceLocalService) {
				_service = (complianceLocalService)invokableLocalService;
			}
			else {
				_service = new complianceLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(complianceLocalServiceUtil.class,
				"_service");
		}
	...
	private static complianceLocalService _service;
}