...
/**
 * Provides the local service interface for annualreports. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author CloverLiferay02
 * @see annualreportsLocalServiceUtil
...
public interface annualreportsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link annualreportsLocalServiceUtil} to access the annualreports local service. Add custom service methods to {@link com.chola.annual.service.impl.annualreportsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public annualreports addannualreports(annualreports annualreports);
	...
	*/
	public annualreports createannualreports(long id);
	...
	*/
	...
	public annualreports deleteannualreports(annualreports annualreports);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public annualreports deleteannualreports(long id) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public annualreports fetchannualreports(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public annualreports getannualreports(long id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public annualreports updateannualreports(annualreports annualreports);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<annualreports> getannualreportses(int start, int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<java.lang.String> getdata();
