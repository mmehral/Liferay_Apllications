...
/**
 * The persistence interface for the annualreports service.
 *
 * <p>
 ...
 * @see annualreportsUtil
 * @generated
 */
@ProviderType
public interface annualreportsPersistence extends BasePersistence<annualreports> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link annualreportsUtil} to access the annualreports persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<annualreports> annualreportses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, annualreports> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<annualreports> findAll();
	...
	*/
	public java.util.List<annualreports> findAll(int start, int end);
	...
	*/
	public java.util.List<annualreports> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<annualreports> orderByComparator);
