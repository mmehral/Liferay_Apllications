...
public class bsoppathWrapper implements bsoppath, ModelWrapper<bsoppath> {
	...
	@Override
	public com.chola.bsop.model.bsoppath toEscapedModel() {
		return new bsoppathWrapper(_bsoppath.toEscapedModel());
	}

	@Override
	public com.chola.bsop.model.bsoppath toUnescapedModel() {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<com.chola.bsop.model.bsoppath> toCacheModel() {
		return _bsoppath.toCacheModel();
	}

	@Override
	public int compareTo(com.chola.bsop.model.bsoppath bsoppath) {
