 ...
 */
@ProviderType
public class bookpathLocalServiceClp implements bookpathLocalService {
	public bookpathLocalServiceClp(InvokableLocalService invokableLocalService) {
		_invokableLocalService = invokableLocalService;

		_methodName0 = "addbookpath";

		_methodParameterTypes0 = new String[] { "com.chola.book.model.bookpath" };

		_methodName1 = "createbookpath";

		_methodParameterTypes1 = new String[] { "long" };

		_methodName2 = "deletebookpath";

		_methodParameterTypes2 = new String[] { "com.chola.book.model.bookpath" };

		_methodName3 = "deletebookpath";

		_methodParameterTypes3 = new String[] { "long" };

		_methodName4 = "fetchbookpath";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "getbookpath";

		_methodParameterTypes5 = new String[] { "long" };

		_methodName6 = "updatebookpath";

		_methodParameterTypes6 = new String[] { "com.chola.book.model.bookpath" };
		...
		_methodName12 = "getbookpathsCount";
	...
	public com.chola.book.model.bookpath addbookpath(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(bookpath) });
		}
		catch (Throwable t) {
		...
		return (com.chola.book.model.bookpath)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.chola.book.model.bookpath> getBookDetails(
		...
		return (java.util.List<com.chola.book.model.bookpath>)ClpSerializer.translateOutput(returnObj);
	}
