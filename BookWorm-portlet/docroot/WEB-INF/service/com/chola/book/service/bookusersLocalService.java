...
/**
 * Provides the local service interface for bookusers. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author CloverLiferay02
 * @see bookusersLocalServiceUtil
...
public interface bookusersLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link bookusersLocalServiceUtil} to access the bookusers local service. Add custom service methods to {@link com.chola.book.service.impl.bookusersLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<bookusers> getBookDetails(long bookId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<bookusers> getSOPUsers(long user_id);
