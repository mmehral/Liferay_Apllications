...
/**
 * The persistence interface for the md speaks service.
 *
 * <p>
 ...
 */
@ProviderType
public interface MdSpeaksPersistence extends BasePersistence<MdSpeaks> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MdSpeaksUtil} to access the md speaks persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<MdSpeaks> mdSpeakses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, MdSpeaks> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<MdSpeaks> findAll();
	...
	*/
	public java.util.List<MdSpeaks> findAll(int start, int end);
	...
	*/
	public java.util.List<MdSpeaks> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<MdSpeaks> orderByComparator);
