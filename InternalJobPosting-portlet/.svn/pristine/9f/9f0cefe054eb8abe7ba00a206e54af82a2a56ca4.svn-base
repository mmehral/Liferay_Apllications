...
InternalReference  ref=(InternalReference)row.getObject();
%>
<%
...
<liferay-ui:icon  image="edit" message="Edit reference" url="<%=editURL.toString() %>"/>

<liferay-ui:icon-delete url="<%=deleteURL.toString()%>" image="delete"
		message="Delete reference"></liferay-ui:icon-delete>
</liferay-ui:icon-menu>
