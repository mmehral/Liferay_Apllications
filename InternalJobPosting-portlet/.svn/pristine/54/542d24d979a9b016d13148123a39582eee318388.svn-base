 ...
 */
@ProviderType
public class InternalReferenceLocalServiceClp
	implements InternalReferenceLocalService {
	public InternalReferenceLocalServiceClp(
		...
		_methodName4 = "fetchInternalReference";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "getInternalReference";

		_methodParameterTypes5 = new String[] { "long" };

		_methodName6 = "updateInternalReference";
		...
		_methodName12 = "getInternalReferencesCount";
		...
		_methodName18 = "getInternalReferences";
	...
	public com.chola.InternalJobRef.model.InternalReference addInternalReference(
		...
		return (com.chola.InternalJobRef.model.InternalReference)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.chola.InternalJobRef.model.InternalReference createInternalReference(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { refId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.chola.InternalJobRef.model.InternalReference deleteInternalReference(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName3,
					_methodParameterTypes3, new Object[] { refId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.chola.InternalJobRef.model.InternalReference fetchInternalReference(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName4,
					_methodParameterTypes4, new Object[] { refId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.chola.InternalJobRef.model.InternalReference getInternalReference(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName5,
					_methodParameterTypes5, new Object[] { refId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.chola.InternalJobRef.model.InternalReference> getInternalReferences(
		...
		return (java.util.List<com.chola.InternalJobRef.model.InternalReference>)ClpSerializer.translateOutput(returnObj);
	}
