...
/**
 * The persistence interface for the shutterspeedgallery service.
 *
 * <p>
 ...
 * @see shutterspeedgalleryUtil
 * @generated
 */
@ProviderType
public interface shutterspeedgalleryPersistence extends BasePersistence<shutterspeedgallery> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link shutterspeedgalleryUtil} to access the shutterspeedgallery persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public java.util.List<shutterspeedgallery> findByCONTENT_ID(long content_id);
	...
	*/
	public java.util.List<shutterspeedgallery> findByCONTENT_ID(
	...
	*/
	public java.util.List<shutterspeedgallery> findByCONTENT_ID(
		long content_id, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<shutterspeedgallery> orderByComparator);
	...
	*/
	public void cacheResult(
		java.util.List<shutterspeedgallery> shutterspeedgalleries);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, shutterspeedgallery> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<shutterspeedgallery> findAll();
	...
	*/
	public java.util.List<shutterspeedgallery> findAll(int start, int end);
