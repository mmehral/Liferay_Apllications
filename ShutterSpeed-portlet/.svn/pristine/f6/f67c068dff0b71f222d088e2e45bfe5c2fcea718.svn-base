 ...
 * @generated
 */
public class shutterspeedgalleryFinderBaseImpl extends BasePersistenceImpl<shutterspeedgallery> {
	@Override
	public Set<String> getBadColumnNames() {
		return getshutterspeedgalleryPersistence().getBadColumnNames();
	}
