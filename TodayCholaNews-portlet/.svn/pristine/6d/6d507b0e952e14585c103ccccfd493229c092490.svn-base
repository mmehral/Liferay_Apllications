<%@page import="com.chola.TodaycholaNews.model.TodayCholaNews"%>
<%@page import="com.chola.TodaycholaNews.service.TodayCholaNewsLocalServiceUtil"%>
...
<% 
		int count = TodayCholaNewsLocalServiceUtil.getTodayCholaNewsesCount();
		System.out.println("%%%%%" + count);
		List<TodayCholaNews> list = (List<TodayCholaNews>) TodayCholaNewsLocalServiceUtil
				.getTodayCholaNewses(0, count);
	...
	%>
<liferay-ui:header title="Show today Chola live feed"
	backLabel="&laquo; Back to search" backURL="<%=backURL.toString()%>" />
	<liferay-ui:search-container delta="3"
	   total="<%=TodayCholaNewsLocalServiceUtil.getTodayCholaNewsesCount()%>"
	...
	<liferay-ui:search-container-row modelVar="list1" className="TodayCholaNews">
