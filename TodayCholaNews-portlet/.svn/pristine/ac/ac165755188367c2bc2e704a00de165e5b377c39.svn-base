...
/**
 * The base model interface for the TodayCholaNews service. Represents a row in the &quot;chola_TodayCholaNews&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.chola.TodaycholaNews.model.impl.TodayCholaNewsModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.chola.TodaycholaNews.model.impl.TodayCholaNewsImpl}.
 * </p>
 *
 * @author adms.java1
 * @see TodayCholaNews
 ...
 */
@ProviderType
public interface TodayCholaNewsModel extends BaseModel<TodayCholaNews> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a today chola news model instance should use the {@link TodayCholaNews} interface instead.
	 */
