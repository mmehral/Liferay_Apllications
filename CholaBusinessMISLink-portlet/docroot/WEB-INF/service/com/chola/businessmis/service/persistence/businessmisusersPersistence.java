...
/**
 * The persistence interface for the businessmisusers service.
 *
 * <p>
 ...
 * @see businessmisusersUtil
 * @generated
 */
@ProviderType
public interface businessmisusersPersistence extends BasePersistence<businessmisusers> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link businessmisusersUtil} to access the businessmisusers persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public java.util.List<businessmisusers> findByBUSINESS_ID(
	...
	*/
	public java.util.List<businessmisusers> findByBUSINESS_ID(
		long businessdetails_id, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<businessmisusers> orderByComparator);
	...
	* @return the matching businessmisuserses
	*/
	public java.util.List<businessmisusers> findByUSER_ID(long user_id);
	...
	*/
	public void cacheResult(java.util.List<businessmisusers> businessmisuserses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, businessmisusers> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<businessmisusers> findAll();
	...
	*/
	public java.util.List<businessmisusers> findAll(int start, int end);
