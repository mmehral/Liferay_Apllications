 ...
 */
@ProviderType
public class businessmisusersClp extends BaseModelImpl<businessmisusers>
	implements businessmisusers {
	public businessmisusersClp() {
	}
	...
	public void setId(long id) {
		...
		if (_businessmisusersRemoteModel != null) {
			try {
				Class<?> clazz = _businessmisusersRemoteModel.getClass();

				Method method = clazz.getMethod("setId", long.class);

				method.invoke(_businessmisusersRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setUser_id(long user_id) {
		...
		if (_businessmisusersRemoteModel != null) {
			try {
				...
				method.invoke(_businessmisusersRemoteModel, user_id);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setBusinessdetails_id(long businessdetails_id) {
		...
		if (_businessmisusersRemoteModel != null) {
			try {
				...
				method.invoke(_businessmisusersRemoteModel, businessdetails_id);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getbusinessmisusersRemoteModel() {
		return _businessmisusersRemoteModel;
	}

	public void setbusinessmisusersRemoteModel(
		BaseModel<?> businessmisusersRemoteModel) {
		_businessmisusersRemoteModel = businessmisusersRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _businessmisusersRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_businessmisusersRemoteModel,
	...
	public businessmisusers toEscapedModel() {
		return (businessmisusers)ProxyUtil.newProxyInstance(businessmisusers.class.getClassLoader(),
			new Class[] { businessmisusers.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		businessmisusersClp clone = new businessmisusersClp();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof businessmisusersClp)) {
			return false;
		}

		businessmisusersClp businessmisusers = (businessmisusersClp)obj;
	...
	private BaseModel<?> _businessmisusersRemoteModel;
