...
<liferay-ui:header title="Show Referal" backLabel="Back" backURL="<%=backURL.toString()%>" />
...
<aui:validator name="required" errorMessage="Please Enter Sender's mail id"></aui:validator>
<aui:validator name="max">100</aui:validator>
<aui:validator name="email"></aui:validator>
</aui:input>
 --%><aui:input name="To" type="text"  helpMessage="Please Enter Receive mail id" >
<aui:validator name="required" errorMessage="Please Enter Receiver's mail id"></aui:validator>
<aui:validator name="max">100</aui:validator>
<aui:validator name="email"></aui:validator>
</aui:input>
