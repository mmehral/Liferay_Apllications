...
/**
 * Provides the local service interface for EmployeeRefrence. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author CloverLiferay03
 * @see EmployeeRefrenceLocalServiceUtil
...
public interface EmployeeRefrenceLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmployeeRefrenceLocalServiceUtil} to access the employee refrence local service. Add custom service methods to {@link com.chola.EmployeeRef.service.impl.EmployeeRefrenceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public EmployeeRefrence addEmployeeRefrence(
	...
	*/
	public EmployeeRefrence createEmployeeRefrence(long refId);
	...
	*/
	...
	public EmployeeRefrence deleteEmployeeRefrence(
		EmployeeRefrence employeeRefrence);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public EmployeeRefrence deleteEmployeeRefrence(long refId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmployeeRefrence fetchEmployeeRefrence(long refId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmployeeRefrence getEmployeeRefrence(long refId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public EmployeeRefrence updateEmployeeRefrence(
		EmployeeRefrence employeeRefrence);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EmployeeRefrence> getEmployeeRefrences(int start, int end);
