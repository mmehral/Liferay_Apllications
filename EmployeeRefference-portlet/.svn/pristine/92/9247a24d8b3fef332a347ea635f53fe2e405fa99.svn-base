 ...
 */
@ProviderType
public class EmployeeRefrenceLocalServiceClp
	implements EmployeeRefrenceLocalService {
	public EmployeeRefrenceLocalServiceClp(
		...
		_methodName4 = "fetchEmployeeRefrence";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "getEmployeeRefrence";

		_methodParameterTypes5 = new String[] { "long" };

		_methodName6 = "updateEmployeeRefrence";
		...
		_methodName12 = "getEmployeeRefrencesCount";
		...
		_methodName18 = "getEmployeeRefrences";
	...
	public com.chola.EmployeeRef.model.EmployeeRefrence addEmployeeRefrence(
		...
		return (com.chola.EmployeeRef.model.EmployeeRefrence)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.chola.EmployeeRef.model.EmployeeRefrence> getEmployeeRefrences(
		...
		return (java.util.List<com.chola.EmployeeRef.model.EmployeeRefrence>)ClpSerializer.translateOutput(returnObj);
	}
